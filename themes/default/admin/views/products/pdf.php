            ...
            <div class="col-sm-7">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dfTable table-right-left">
                        ...
                        ?>
							<tr>
                                <td><?= lang("minimum_quantity"); ?></td>
                                <td><?= $this->sma->formatQuantity($product->minimum_quantity); ?></td>
                            </tr>
                            <tr>
                                <td><?= lang("reorder_quantity"); ?></td>
                                <td><?= $this->sma->formatQuantity($product->reorder_quantity); ?></td>
                            </tr>
                            <tr>
                                <td><?= lang("open_stock_quantity"); ?></td>
                                <td><?= $this->sma->formatQuantity($product->open_stock_quantity); ?></td>
                            </tr>
