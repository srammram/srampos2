...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#PRData').dataTable({
            ...
            'bProcessing': true, 'bServerSide': true,"bStateSave": true,
		...
		$index = oSettings._iDisplayStart+parseInt(iDisplayIndex) +parseInt(1) ;
            ...
            "aoColumns": [
                null,{"bSortable": false, "mRender": checkbox}, null,{"bSortable": false,"mRender": img_hl}, null, null, null, null, null,  {"mRender": product_status},  {"bSortable": false}
            ]
