    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row padding10">
            	 <div class="col-xs-4">
            		<p><?= $this->lang->line("to"); ?></p>
                    <h2 class=""><?=$supplier->company ? $supplier->company : $supplier->name;?></h2>
                    <p><?=$supplier->company ? "" : "Attn: " . $supplier->name?></p>
                    <p><?php echo $supplier->address . "<br />" . $supplier->city . " " . $supplier->postal_code . " " . $supplier->state . "<br />" . $supplier->country; ?></p>
                    <?php
					echo "<p>";
                        ...
                        echo "</p>";
					?>
                    <p><?php echo lang("tel") . ": " . $supplier->phone . "<br />" . lang("email") . ": " . $supplier->email; ?></p>
                  </div>
                  
                  <div class="col-xs-6 pull-right  order_barcodes">
                  	<p><?= $this->lang->line("from"); ?></p>
                    <h2 class=""><h2 class=""><?=$Settings->site_name;?></h2></h2>
                    <p><?=$warehouse->name?></p>
                    <p><?php
