...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_inventory'); ?></h2>
    </div>
                    ...
                    <div class="col-lg-12">
                        ...
                        -->
                         <div class="col-md-6" style="padding-bottom: 10px;">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
								<?php echo form_input('grn_date', (isset($_POST['grn_date']) ? $_POST['grn_date'] : ""), 'class="form-control input-tip totay_date" id="grn_date" required="required"'); ?>
								</div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="padding-bottom: 10px;">
                                <div class="form-group">
                                   ...
                                   $pn[''] = '';
                                    ...
                                    echo form_dropdown('poref', $pn, (isset($_POST['poref']) ? $_POST['poref'] : '' ), ' class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("po_number") . '"style="width:100%;" id="porefnumber" required="required" ');
                                    ?>
									</div>
                                </div>
                            </div>
                        <div class="col-md-6" style="padding-bottom: 10px;">
                            <div class="form-group">
                               ...
                               <div class="col-md-7">
                                <?php echo form_input('invoice_no', (isset($_POST['invoice_no']) ? $_POST['invoice_no'] : ""), 'class="form-control input-tip" id="invoice_no" required="required"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6" style="padding-bottom: 10px;">
                            <div class="form-group">
                                ...
                                <div class="col-md-7">
                                <?php  ?>
                                <?php echo form_input('invoice_date', (isset($_POST['invoice_date']) ? $_POST['invoce_date'] : ""), 'class="form-control input-tip today_date" id="invoicedate" required="required" required="required"'); ?>
                                </div>
                            </div>
                        </div>
						...
						<div class="col-md-6" style="padding-bottom: 10px;">
                            <div class="form-group">
                               ...
                               <div class="col-md-7">
                                <?php echo form_input('purchases_order_date', (isset($_POST['purchases_order_date']) ? $_POST['purchases_order_date'] : ""), 'class="form-control input-tip totay_date" id="purchases_order_date" required="required"'); ?>
								</div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6" style="padding-bottom: 10px;">
                                <div class="form-group">
                                   ...
                                   <div class="col-md-7">
                                    ...
                                    echo form_dropdown('warehouse', $wh, (isset($_POST['warehouse']) ? $_POST['warehouse'] :''), 'id="powarehouse" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("warehouse") . '" required="required" style="width:100%;" ');
                                    ?>
									</div>
                                </div>
                            </div>
            ...
            <div class="modal-body" id="pr_popover_content">
                <form class="form-horizontal" role="form">
                    ...
                    <?php if ($Settings->product_expiry) { ?>
                    	<div class="form-group">
                            <label for="pmfg" class="col-sm-4 control-label"><?= lang('purchase_items_mfg') ?></label>
                        ...
                        <div class="form-group">
                            <label for="pexpiry" class="col-sm-4 control-label"><?= lang('purchase_items_expiry') ?></label>
                    ...
                    <?php } ?>
                    <div class="form-group">
                        <label for="punit" class="col-sm-4 control-label"><?= lang('purchase_items_unit') ?></label>
                        <div class="col-sm-8">
                            <div id="punits-div"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="poption" class="col-sm-4 control-label"><?= lang('purchase_items_option') ?></label>
                        <div class="col-sm-8">
                    ...
                    <?php if ($Settings->product_discount) { ?>
                        <div class="form-group">
                            <label for="pdiscount" class="col-sm-4 control-label"><?= lang('purchase_items_discount') ?></label>
                            <div class="col-sm-8">
                    ...
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <th style="width:25%;"><?= lang('purchase_items_tax'); ?></th>
