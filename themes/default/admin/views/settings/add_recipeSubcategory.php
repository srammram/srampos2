...
<div class="modal-dialog">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?php echo lang('Add_Recipe_Sub_Groups'); ?></h4>
        </div>
        <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form');
        //echo admin_form_open_multipart("system_settings/add_recipecategory", $attrib); ?>
	<form data-url="<?=admin_url('system_settings/add_recipecategory?sub=1')?>" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate class="bv-form" id="add-category">
    ...
    cursor: pointer;">
	    ...
	    <input type="hidden" name="add_recipecategory" value="<?=lang('add_recipe_category')?>">
            <?php echo form_submit('add_recipecategory', lang('add_recipe_sub_category'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
