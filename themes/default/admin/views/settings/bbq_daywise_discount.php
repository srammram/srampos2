...
<script>
    $(document).ready(function () {
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/get_daywise_discount') ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                          <!--   <a href="<?= admin_url('recipe/recipe_and_variant_addon_add') ?>">
                                <i class="fa fa-plus-circle"></i> <?= lang('recipe_and_variant_addon_add') ?>
                            </a> -->

                            <a href="<?= admin_url('system_settings/add_bbq_daywise_discount'); ?>"><i class="fa fa-plus"></i> <?= lang('add_bbq_daywise_discount') ?></a></li>
