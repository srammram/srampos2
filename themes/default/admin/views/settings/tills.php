...
<script>
    $(document).ready(function () {
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/getTills') ?>',
...
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown"><a href="<?php echo admin_url('system_settings/add_tills'); ?>"
                ...
                <div class="table-responsive">
                    <table id="CURData" class="table table-bordered table-hover table-striped reports-table">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line("system_name"); ?></th>
                            <th><?php echo $this->lang->line("system_ip"); ?></th>
                            <th><?php echo $this->lang->line("till_name"); ?></th>
