    ...
    <div class="box-content">
        <div class="row group-permission">
            <div class="col-lg-12">
				...
				<tr>
				    <td><?= lang("sale_items_ingredients"); ?></td>
				    <td class="text-center">
					<input type="checkbox" value="1" class="checkbox" name="recipe-list_ingredients" <?php echo $p->{'recipe-list_ingredients'} ? "checked" : ''; ?>>
				    </td>
				    <td class="text-center">
					<input type="checkbox" value="1" class="checkbox" name="recipe-add_ingredients" <?php echo $p->{'recipe-add_ingredients'} ? "checked" : ''; ?>>
				    </td>
				    <td class="text-center">
					<input type="checkbox" value="1" class="checkbox" name="recipe-ingredients_edit" <?php echo $p->{'recipe-ingredients_edit'} ? "checked" : ''; ?>>
				    </td>
				    <td class="text-center">
					<input type="checkbox" value="1" class="checkbox" name="recipe-ingredients_delete" <?php echo $p->{'recipe-ingredients_delete'} ? "checked" : ''; ?>>
				    </td>
				    <td>
					<input type="checkbox" value="1" id="recipe-ingredients_import_csv" class="checkbox" name="recipe-ingredients_import_csv" <?php echo $p->{'recipe-ingredients_import_csv'} ? "checked" : ''; ?>>
					<label for="recipe-ingredients_import_csv" class="padding05"><?= lang('ingredients_import_csv') ?></label>					
				    </td>	
				</tr>
				...
				<tr>
						        ...
						        <tr class="reports">
									...
									<ul>
									    ...
									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-store_request_reports" name="reports-store_request_reports" <?php echo $p->{'reports-store_request_reports'} ? "checked" : ''; ?>>
										<label for="reports-store_request_reports" class="padding05"><?= lang('store_request_reports') ?></label>
									    </span>
									    </li>

									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-quotes_request_reports" name="reports-quotes_request_reports" <?php echo $p->{'reports-quotes_request_reports'} ? "checked" : ''; ?>>
										<label for="reports-quotes_request_reports" class="padding05"><?= lang('quotes_request_reports') ?></label>
									    </span>
									    </li>

									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-quotation_reports" name="reports-quotation_reports" <?php echo $p->{'reports-quotation_reports'} ? "checked" : ''; ?>>
										<label for="reports-quotation_reports" class="padding05"><?= lang('quotation_reports') ?></label>
									    </span>
									    </li>

									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-purchase_order_reports" name="reports-purchase_order_reports" <?php echo $p->{'reports-purchase_order_reports'} ? "checked" : ''; ?>>
										<label for="reports-purchase_order_reports" class="padding05"><?= lang('purchase_order_reports') ?></label>
									    </span>
									    </li>

									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-purchase_invoice_reports" name="reports-purchase_invoice_reports" <?php echo $p->{'reports-purchase_invoice_reports'} ? "checked" : ''; ?>>
										<label for="reports-purchase_invoice_reports" class="padding05"><?= lang('purchase_invoice_reports') ?></label>
									    </span>
									    </li> 

									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-purchase_return_reports" name="reports-purchase_return_reports" <?php echo $p->{'reports-purchase_return_reports'} ? "checked" : ''; ?>>
										<label for="reports-purchase_return_reports" class="padding05"><?= lang('purchase_return_reports') ?></label>
									    </span>
									    </li>

									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-purchase_order_summary_reports" name="reports-purchase_order_summary_reports" <?php echo $p->{'reports-purchase_order_summary_reports'} ? "checked" : ''; ?>>
										<label for="reports-purchase_order_summary_reports" class="padding05"><?= lang('purchase_order_summary_reports') ?></label>
									    </span>
									    </li> 
									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-purchase_invoice_summary_reports" name="reports-purchase_invoice_summary_reports" <?php echo $p->{'reports-purchase_invoice_summary_reports'} ? "checked" : ''; ?>>
										<label for="reports-purchase_invoice_summary_reports" class="padding05"><?= lang('purchase_invoice_summary_reports') ?></label>
									    </span>
									    </li>
									    <li>
									    <span style="inline-block">
										<input type="checkbox" value="1" class="checkbox" id="reports-item_stock" name="reports-item_stock" <?php echo $p->{'reports-item_stock'} ? "checked" : ''; ?>>
										<label for="reports-item_stock" class="padding05"><?= lang('item_stock') ?></label>
									    </span>
									    </li>
                            ...
                            <table class="table table-bordered table-hover table-striped reports-table">
                                ...
                                <tr>
                                 ...
                                 <tr class="orders-settings">
									...
									<label for="pos-change_multiple_status" class="padding05"><?= lang('cancel_multiple_option') ?></label>
									</span>
									</li>
									<li>
									<span style="inline-block">
