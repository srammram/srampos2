...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-folder-open"></i><?= lang('add_bbq_menu'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row group-permission">
            <div class="col-lg-12">
                <p class="introtext"><?= lang('add_bbq_menu'); ?></p>
                <?php 
                        echo admin_form_open("system_settings/add_bbq_menu/"); ?>
                        <div class="col-md-6">
                            <div class="form-group">
                                <?= lang("select_bbq_menu", "select_bbq_menu"); ?>
                                 <select style="display: "  name="sale_type" class="form-control pos-input-tip sale_type" id="sale_type">
                                    ...
                                    ?>
                                    <option value="<?php echo $saletype->id; ?>"><?php echo $saletype->name; ?>
                                    </option>
                                <?php } ?>
                                </select>                 
                            </div>
                                ...
                                ?>                               
                                 <tr class="items">
                                    <td>
                                        ...
                                        <input type="hidden" name="days[]" class="form-control tip" value="<?=$day?>">
                                    ...
                                    <td>                                        
                                         <div class="col-md-12">
                                            <div class="form-group">                                                
                                                    <input type="text" name="adult_price[]" id="adult_price_<?=$day?>" maxlength="15" class="form-control tip numberonly">
                                            </div>
                                    </td>
                                   <td >                                        
                                         <div class="col-md-12">
                                            <div class="form-group">                                                
                                                    <input type="text" name="child_price[]" id="child_price_<?=$day?>"  maxlength="15" class="form-control tip numberonly">
                                            </div>
                                    </td>
                                    <td>                                        
                                         <div class="col-md-12">
                                            <div class="form-group">                                                
                                                    <input type="text" name="kids_price[]" id="kids_price_<?=$day?>" maxlength="15" class="form-control tip numberonly">
                                            </div>
                                    </td>
                                </tr>   
                                <?php } ?>                       
