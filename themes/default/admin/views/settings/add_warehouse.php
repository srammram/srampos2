...
//                echo form_dropdown('price_group', $pgs, $Settings->price_group, 'class="form-control tip select" id="price_group" style="width:100%;"');
            ...
            <div class="form-group">
                ...
                <?php echo form_input('phone', '', 'class="form-control numberonly" id="phone" required="required" onkeydown="return(event.which == 8 && event.which == 0 || (event.charCode >= 48 || event.which <= 57))" maxlength="30"'); ?>
            </div>
            <div class="form-group">
