...
<script>
    $(document).ready(function () {
        oTable = $('#CURData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('system_settings/get_shift_times') ?>',
            ...
            "aoColumns": [null,{"bSortable": false, "mRender": checkbox},  null, null, null, {"mRender": change_shift_time_status},{"bSortable": false}]
        });
    });
</script>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('system_settings/add_shift_time'); ?>" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> <?= lang('add_shift_time') ?></a></li>
