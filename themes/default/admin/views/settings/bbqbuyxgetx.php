            ...
            <div class="col-lg-12">
                ...
                <?php 
                                 ...
                                 <tr class="items">
                                    	...
                                    	<div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php 
														$adult_get[0] = 'Get';
														for($j=1; $j<$buyxgetx_data->adult_buy; $j++){
														$adult_get[$j] = $j;
														}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php 
														$child_get[0] = 'Get';
														for($j=1; $j<$buyxgetx_data->child_buy; $j++){
														$child_get[$j] = $j;
														}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php 
														$kids_get[0] = 'Get';
														for($j=1; $j<$buyxgetx_data->kids_buy; $j++){
														$kids_get[$j] = $j;
														}
                                    ...
                                    <td>
                                        ...
                                        if($buyxgetx_data->days == $day){ ?>
                                          ...
                                          <p id="detele_get_buy"  data ="<?php echo $buyxgetx_data->id; ?>" class="btn btn-primary a-btn-slide-text">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary" id="update_bbqbuyxgetx"><?=lang('update')?></button>
                        </div>
                        <?php echo form_close();
                   ?>
...
/*$(document).on('click', '#update_bbqbuyxgetx', function () {
    $('.days').each(function () {        
        $this = $(this);
        $days = $(this).val();
        if(($this).is(':checked')){            
...
$(document).on('click', '#detele_get_buy', function () {    
    ...
    $.ajax({
            type: "POST",
            url: "<?=admin_url('system_settings/deletebbqbuyxgetx')?>",
            data: {id: id},
            dataType: "json",
...
$(document).on('change', '.adult_buy', function(){
    ...
    $('#adult_get_'+days).empty().trigger('change');
    $("#adult_get_"+days).append(
            $("<option></option>")
                .attr("value", 0)
                .text('GET')
        );    
...
$(document).on('change', '.child_buy', function(){
    ...
    $('#child_get_'+days).empty().trigger('change');
    $("#child_get_"+days).append(
            $("<option></option>")
                .attr("value", 0)
                .text('GET')
        );    
