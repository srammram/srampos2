...
<div class="modal-dialog">
    <div class="modal-content">
		...
		<label><?=lang('select_warehouse')?><?php if(empty($warehouses)){ ?>: <?=lang('no_warehouse_created')?> <?php } ?></label></br>
		<?php if(!empty($warehouses)) :foreach($warehouses as $k => $row) : ?>		
...
//                echo form_dropdown('price_group', $pgs, $warehouse->price_group_id, 'class="form-control tip select" id="price_group" style="width:100%;"');
            ...
            <div class="form-group">
                ...
                <?php echo form_input('phone', $warehouse->phone, 'class="form-control numberonly" id="phone" required="required" onkeydown="return(event.which == 8 && event.which == 0 || (event.charCode >= 48 || event.which <= 57))" maxlength="30"'); ?>
            </div>
            <div class="form-group">
			 ...
			 <div class="form-group">
                ...
                <?php echo form_input('vat_number', $warehouse->vat_number, 'class="form-control" id="vatname" required="required"'); ?>
            </div>
            <div class="form-group">
        ...
        <div class="modal-footer">
            <?php echo form_submit('edit_warehouse', lang('update_warehouse'), 'class="btn btn-primary"'); ?>
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
