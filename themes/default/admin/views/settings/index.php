                    ...
                    <fieldset class="scheduler-border">
                        <legend class="scheduler-border"><?= lang('Notification') ?></legend>
                         <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group notification_start_interval">
                               
                                    <label class="control-label" for="notification_time_interval"><?= lang("notification_start_time_interval")?> <span style="font-size:10px;">[in secs]</span></label>
                                    <?= form_input('notification_start_interval', ($Settings->notification_start_interval!=0)?$Settings->notification_start_interval:'', 'class="form-control numberonly" id="notification_start_interval"'); ?>
