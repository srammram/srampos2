...
<script type="text/javascript" src="<?=$assets ?>js/category_subcategory_sale_items_mapping.js"></script>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_sale_item_mapping_by_saletype_and_day'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <?php
                 /*$attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'add-cus-dis-form');
        		echo admin_form_open("system_settings/sale_item_mapping_by_saletype_and_day/", $attrib);*/ 
                ...
                <div class="discount-container col-lg-12">
                    ...
                    <div class="col-md-2" >
                        ...
                        <label style="padding:7px;">
                                <input type="checkbox" name="check_all" class="check_all" >&nbsp<?=lang('check_all')?>
                            </label>
                        </div>
                    </div>

                <input type="hidden" name="sales_map_hd_id" value="<?=$id?>">
                                        ...
                                        <?=@lang('excluded')?></label>
                                            ...
                                            <?php if(!empty($row_2->recipes)) : ?>
                                                <ul class="level-3-menu"><div class="items-title">items</div>
                                                    ...
                                                    $mapped_rids1 = $this->site->checksaleitemsmapped($id,$row_2->id);
                                                    // print_r($mapped_rids1);die;
                                                    $mapped_rids = explode(',', $mapped_rids1);
                                                    // print_r($mapped_rids);
