...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        echo admin_form_open("suppliers/add_user/" . $company->id, $attrib); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('phone', '', 'class="form-control" id="phone" onkeydown="return(event.which == 8 && event.which == 0 || (event.charCode >= 48 || event.which <= 57))" maxlength="10"'); ?>
                        </div>
                    </div>
