    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
           ...
           <div class="form-group">
            ...
            echo form_dropdown('supplier_type', $types, $supplier->supplier_type, 'class="form-control select" id="supplier_type" required="required"'); ?>
                </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group person">
                     ...
                     <div class="form-group short_name">
                        ...
                        <?php echo form_input('short_name', $supplier->short_name, 'class="form-control tip" id="short_name"'); ?>
                    </div>
                    <div class="form-group">
                        <?= lang("vat_no", "vat_no"); ?>
                    ...
                    <div class="form-group">
                        <?= lang("phone", "phone"); ?>
                        <input type="tel" name="phone" maxlength="10" class="form-control numberonly" required="required" id="phone"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="conatct_person_name" class="form-control"  id="conatct_person_name"
                               value="<?= $supplier->conatct_person_name ?>"/>
                    </div>
                    <div class="form-group">
                        <?= lang("mobile_number"); ?>
                    ...
                    <div class="form-group">
                        <?= lang("bank_details"); ?>
                        <textarea name="bank_details" class="form-control skip" id="bank_details" style="height:100px;" ><?= $supplier->bank_details ?></textarea>
                    </div>
                 ...
                 <!--    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						echo form_dropdown('tax_type', $tr, $supplier->tax_type, 'class="form-control tax_type" ');
						?>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('postal_code', $supplier->postal_code, 'class="form-control numberonly" maxlength="6" id="postal_code"'); ?>
                    </div>
                    <div class="form-group">
			...
			<div class="form-group">
                    <?= lang("status", "supplier_type"); ?>
                    <?php $st = array('1' => lang('active'), '0' => lang('inactive'));
            echo form_dropdown('is_status', $st, $supplier->is_status, 'class="form-control select" id="is_status" required="required"'); ?>
                </div>
