                ...
                <div id="form">
                       <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('warehouse_id', $wh,$this->store_id, 'class="form-control" data-placeholder="' . lang("select") . ' ' . lang("warehouse") . '" id="warehouse_id" style="width:100%;" ');
                                ?>
                                        ...
                                        $.each(b.split_order, function (c,d) {  
                                            $('#SlRData > tbody').append('<tr><td style = "text-align:left"><strong>Sub Group:</strong>'+d.sub_category+'</td></tr>');  
                                             ...
                                             $.each(d.order, function (e,f) {
												 ...
												 $unit_name=(f.unit_name !=null)?f.unit_name:f.unitname;
                                                $('#SlRData > tbody').append('<tr  class="text-right"><td class="text-center">'+f.name+'</td><td class="text-center">'+f.variant+'</td><td>'+f.warehouse+'</td><td>'+formatDecimal(f.w_qty,4)+'</td><td>'+$unit_name+'</td><td>'+formatMoney(f.w_price)+'</td><td>'+f.type+'</td></tr>');
                                            }); 
