...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('purchase_return_reports'); ?> <?php
    ...
    $(document).ready(function () {
      /*  $('#pdf').click(function (event) {
        ...
        $(document).on('click', '.submit_itemreport', function () {
            $offset = false;
            $url = '<?=admin_url('reports/get_purchase_return_reports');?>';
            GetData($url);
        });
                                ...
                                $('#SlRData > tbody').empty();                                                              
                                    ...
                                    {            
                                        ...
                                        // profit += (parseFloat(b.profit));
                                         ...
                                         $('#SlRData > tbody').append('<tr><td>'+$row_index+'</td><td class="text-center">'+b.reference_no+'</td><td class="text-center">'+b.date+'</td><td class="text-center">'+b.supplier+'</td><td class="text-center">'+b.product_code+'</td><td class="text-center">'+b.product_name+'</td><td class="text-center">'+b.received_quantity+'</td><td class="text-center">'+b.quantity+'</td><td class="text-center">'+b.cost+'</td><td class="text-center">'+b.item_disc_amt+'</td><td class="text-center">'+b.item_bill_disc_amt+'</td><td class="text-center">'+b.tax_rate+'</td><td class="text-center">'+b.tax+'</td><td class="text-center">'+b.selling_price+'</td><td class="text-center">'+b.landing_cost+'</td><td class="text-center">'+b.margin+'</td><td class="text-center">'+b.gross+'</td></tr>');
                                        $row_index++;
                                    });

                                  $('#SlRData > tbody').append('<tr style="font-weight:bold"><td colspan="7" >Total: </td><td class="text-right">'+formatDecimal(quantity)+'</td><td class="text-right">'+formatMoney(cost_price)+'</td><td class="text-right">'+formatMoney(item_dis)+'</td><td class="text-right">'+formatMoney(item_bill_disc)+'</td><td></td><td class="text-right">'+formatMoney(tax_amt)+'</td><td class="text-right">'+formatMoney(selling_price)+'</td><td class="text-right">'+formatMoney(landing_cost)+'</td><td></td><td class="text-right">'+formatMoney(gross_amt)+'</td></tr>');
