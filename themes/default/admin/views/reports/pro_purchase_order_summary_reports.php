    ...
    $(document).ready(function () {
      /*  $('#pdf').click(function (event) {
        ...
        $(document).on('click', '.submit_itemreport', function () {
            $offset = false;
            $url = '<?=admin_url('reports/get_purchase_order_summary_reports');?>';
            GetData($url);
        });
                         ...
                         success: function (data) {
                            ...
                            if(data.report =='empty'){ 
                                ...
                                $('#SlRData > tbody').empty();                                                              
                                  ...
                                  $('#SlRData > tbody').append('<tr style="font-weight:bold"><td colspan="5" >Total: </td><td class="text-right">'+formatMoney(gross)+'</td><td class="text-right">'+formatMoney(item_dis)+'</td><td class="text-right">'+formatMoney(item_bill_disc)+'</td><td class="text-right">'+formatMoney(tax_amt)+'</td><td class="text-right">'+formatMoney(round_off)+'</td><td class="text-right">'+formatMoney(grand_total)+'</td></tr>');
