...
<style type="text/css" media="all">
	...
	#printdiv .form-control{background-color: #ecd2c7;border-radius: 0px;color: #000;}
	#printdiv .form-control::placeholder{color: #000; }
	#receipt-datareceipt-data p strong{font-weight: normal;}
...
<div id="wrapper">   
    ...
    <div id="content">
        ...
        <div id="receiptData">
            ...
            <div id="receipt-datareceipt-data" style="padding:0px 15px;">
            <div>
                     ...
                     foreach($table->split_order as $recipesa){ 
                        ...
                        foreach ($recipesa->order as  $value) {
                             ...
                             $grand_total+= (((($value->subtotal-$value->item_discount)-$value->off_discount)-$value->input_discount-$value->manual_item_discount)+$value->tax+$value->service_charge_amount);                             
                              ...
                              $item_style=($value->subtotal==0)?"style='text-decoration: underline;'":"";
                             echo '<tbody>
                                <tr>
								
                                <td '.$item_style.'>'.$value->name.'</td>
...
//                            echo $this->sma->formatMoney($grand_total+$round_val); 
			 ...
			 <h5>Underlined Items are complimentary Items.</h5>
