                            ...
                            <tr>
                               ...
                               if($this->Settings->default_currency != $currency_row->id){
                                    ...
                                    $final_amt = round($final_amt / 100) * 100; ?>                                   
                                        <th colspan="3" class="text-right"><?= $this->sma->exchangeformatMoney($final_amt,$currency_row->symbol)?>
                                <?php }else{
                                    $final_amt = $grandtotal/ $currency_row->rate;?>
                                    <th colspan="3" class="text-right"><?=$this->sma->formatMoney($final_amt,$currency_row->symbol);?>
                              <?php  } ?>                                
