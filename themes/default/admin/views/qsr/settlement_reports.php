...
<div id="wrapper">   
    ...
    <div id="content">
        ...
        <div id="receiptData">
            ...
            <div>    
              ...
              $todate = $this->input->get('todate');
                ...
                echo "<strong><p>" .lang("pos_settlement_reports"). "</p></strong>";
                if($from != $to){
		 ...
		 <?php if(isset($settlement['payments'])) : ?>
		    ...
		    <?php if(isset($row->total_transaction) && $row->total_transaction != 0 ) : ?>
		    ...
		    <?php endforeach; ?>
		<?php endif; ?>
		<?php if(isset($settlement['sale_type'])) : ?>
        ...
        <tr style="font-weight:bold">
            <td class="no-border" style="font-weight: bold;"><?=lang('tender_type')?></td>                
        </tr>

		<?php if(isset($settlement['tender_type'])) : ?>
		<?php foreach($settlement['tender_type'] as $k => $row) : ?>
		<tr style="font-weight:bold">
 ...
 <?php
        ...
        if(isset($settlement['exchange_amt'])) : ?>
...
<script type="text/javascript" src="<?=$assets?>qsr/dragscrollable.js"></script>
<script type="text/javascript" src="<?=$assets?>qsr/dragscroll.js"></script>
<?php
