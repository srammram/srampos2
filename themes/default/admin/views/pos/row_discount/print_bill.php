			...
			<th><?=lang("discount");?></th>
                    ...
                    <tr>
                        ...
                        foreach ($bill_items['item'] as $bill) {                         
                            ...
                            echo '<tr><td colspan="2" style="display: table-cell;text-align: -webkit-match-parent;text-decoration:'.$underline.'"  class="no-border">' . ($star)  . ($recipe_name) .  '</td>'; 

                            echo '<td  class="no-border">'.$this->sma->formatMoney($bill['recipe_price']).'</td>';
			    ...
			    $dis_v=0;
                            ...
                            echo '<td class="no-border text-center">'.$bill['item_cus_dis_val'].'</td>';
                        ...
                        if($manual_discount_amount != 0){
                            ...
                            echo '<td " class="no-border text-right">'.$this->sma->formatMoney($bill['recipe_subtotal']-$bill['manual_item_discount']-$bill['item_cus_dis']).'</td></tr>';
                            $r++;
                        }
                        ?>
                        <tr>
