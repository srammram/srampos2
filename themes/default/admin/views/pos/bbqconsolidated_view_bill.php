        ...
        <div id="receiptData">
            ...
            <div id="receipt-datareceipt-data">
                ...
                if(isset($rough_tender)){
                    ...
                    echo lang("bill_no") . ": " . $dine['inv']->bill_number . "<br>";
                }
               ...
               /* if(isset($rough_tender)){
                ...
                $cashier =  $dine['cashier']->cashier ?  $dine['cashier']->cashier :$dine['cashier']->sales_associate;
            ...
            <div id="receipt-datareceipt-data">
                ...
                echo "<p>" ;
                if(isset($rough_tender)){
                    echo lang("sale_no_ref") . ": " . $bbq['inv']->reference_no . "<br>";
                }else{
                    echo lang("bill_no") . ": " . $bbq['inv']->bill_number . "<br>";
                }
                    ...
                    <tfoot>
                        ...
                        <?php  } 
                           ...
                           <tr>
                                ...
                                <th colspan="4" class="text-right"><?= $bbq['discount'] ? $bbq['discount'] : 'Discount';?></th>
                        ...
                        <?php  } 
                            ...
                            {
                                $taxname = 'Inclusive';
                                $grandtotal = $bbq['inv']->total-$bbq['inv']->total_discount-$bbq['inv']->birthday_discount-$bbq['inv']->bbq_daywise_discount;
                            }
                            else
                            {
                                $taxname = 'Exclusive';
                                $grandtotal = $bbq['inv']->total-$bbq['inv']->total_discount-$bbq['inv']->birthday_discount-$bbq['inv']->bbq_daywise_discount+$bbq['inv']->total_tax;
                            }
							?>
                            <tr>
                                <th colspan="4" class="text-right"><?=lang("grand_total");?></th>
    ...
    left: 0px;" class="no-print">
            ...
            if (!empty($modal)) {
                ...
                <span class="col-xs-12">
                    <a class="btn btn-block btn-warning" href="<?= admin_url('pos/biller_bbqconsolidated/'); ?>"><?= lang("back_to_BBQ_With_Dine_Bills"); ?></a>
                </span>
                <?php
            }
