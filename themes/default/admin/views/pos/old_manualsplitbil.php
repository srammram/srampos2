                ...
                <div id="pos">
                        ...
                        <div id="left-middle">
                                ...
                                <div class="col-lg-12 col-sm-12 col-xs-12 orders draggable " id="origin" style="min-height:200px; background:#fff;">
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12 draggable orders_item">
                                        ...
                                        <div class="rec_price1 item_recipe"><?php echo $item->recipe_name;?>
                                        ...
                                        <div class="rec_price2 item_price rec_price_che"><?php echo $item->unit_price;?><input type="hidden" name="split[<?=$k?>][unit_price][]"  value="<?php echo $item->unit_price; ?>"></div>
                                        <div class="rec_price3 item_quantity"><?php echo $item->quantity;?><input type="hidden" name="split[<?=$k?>][quantity][]"  value="<?php echo $item->quantity; ?>"></div>
                                       ...
                                       <?php echo $dis; ?>
                                        ...
                                        <div class="rec_price7 item_subtotal"><?php echo $price_total;?><input type="hidden" name="split[<?=$k?>][subtotal][]"  value="<?php echo $price_total; ?>"></div>
                    ...
                    <div class="tableright col-sm-4 col-xs-12 manual_click_btn split-form-<?=$i?>">
                            ...
                            <div id="drop_<?php echo $i; ?>_discount_other" class="col-sm-12 col-xs-12 drag_items">
                                <div class="col-sm-6 col-xs-12">Other Discount</div>
                                <div class="col-sm-3 col-xs-12">
                                   <?php if($Settings->customer_discount=='customer') : //customer dis?>
                                    <select style="display: "  name="split[<?=$i?>][order_discount_input]" class="form-control pos-input-tip order_discount_input" id="order_discount_input_<?php echo $i; ?>" count="<?php echo $i; ?>">
                                ...
                                <?php elseif($Settings->customer_discount=='manual') : //manual?>
                                    <?php echo form_input('split['.$i.'][order_discount_input]', '', 'class="kb-pad order_discount_input text-right" id="order_discount_input_'.$i.'" count="'. $i.'"'); ?>
                                <?php endif; ?>
                                </div>
...
$(document).on('change', '.order_discount_input', function () {
    ...
    if(recipeids!=''){
        if(ds !=0){
            $.ajax({
                    ...
                    dataType: "json",
                     async : false,
                    data: {
                        recipeids: recipeids,discountid:$this_obj.val()
                    },
        ...
        if(final_amount >= 0 ){
            ...
            $('#grand_total_'+ $split).val(formatDecimal(sub_val));
            $('#round_total_'+ $split).val(formatDecimal(sub_val));
