        ...
        <div class="row">
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 pos_logo_front">
             <?php if ($this->Settings->logo3) { ?>
                <a href="<?php echo site_url().'admin/pos'; ?>"><img src="<?=base_url()?>assets/uploads/logos/<?=$this->Settings->logo3?>" alt="<?=$this->Settings->site_name?>" class="sram_table_logo" /></a>
           <?php   } ?>
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 custom_details">
                <ul>
                    ...
                    <li class="dropdown"><a data-toggle="dropdown" href="javascript:void(0);"><img src="<?=$assets?>images/dine.png"> <br><?=lang('punch_order')?> <img src="<?=$assets?>images/angle_down.png" class="down_img"></a>
                        <ul class="dropdown-menu">
                        	<?php if($this->sma->actionPermissions('dinein')){ ?>
                            <li><a href="<?php if(!$isNightauditDone) {?> javascript:void(0)<?php } else { echo  admin_url('pos/?order=1'); }?>" <?php if(!$isNightauditDone) {echo 'class="disabled" title="do Nightaudit to enable further orders"';} ?>><?php echo lang("dine_in") ?></a></li>
                            <?php } ?>
                            <?php if($this->sma->actionPermissions('takeaway')){ ?>
                            <li><a href="<?php if(!$isNightauditDone) {?> javascript:void(0)<?php } else { echo  admin_url('pos/?order=2'); }?>" <?php if(!$isNightauditDone) {echo 'class="disabled" title="do Nightaudit to enable further orders"';} ?>><?php echo lang("take_away") ?></a></li>
                            <?php } ?>
					...
					?>
                    <li class="dropdown"><a data-toggle="dropdown" href="javascript:void(0);"><img src="<?=$assets?>images/dine.png"> <br><?=lang('view_orders')?> <img src="<?=$assets?>images/angle_down.png" class="down_img"></a>
                        <ul class="dropdown-menu">
                        	<?php if($this->sma->actionPermissions('dinein_orders')){ ?>
                            <li><a href="<?= admin_url('pos/order_table'); ?>"><?php echo lang("dine_in") ?> </a></li>
                             <?php } ?>
                            <?php if($this->sma->actionPermissions('takeaway_orders')){ ?>
                            <li><a href="<?= admin_url('pos/order_takeaway'); ?>"><?php echo lang("take_away") ?></a></li>
                             <?php } ?>
                            <?php if($this->sma->actionPermissions('door_delivery_orders')){ ?>
                            <li><a href="<?= admin_url('pos/order_doordelivery'); ?>"><?php echo lang("door_delivery") ?></a></li>
                            <?php } ?>
                            <?php if($this->Settings->bbq_enable){ ?>
                    ...
                    ?>
                    <li><a href="<?= admin_url('pos/order_kitchen'); ?>"><img src="<?=$assets?>images/loyalty.png"> <br><?=lang('kitchen')?></a></li>
                    <?php
                    }
                    ?>
                     <?php
                    ...
                    ?>
                     <li class="dropdown"><a data-toggle="dropdown"   href="javascript:void(0);"><img src="<?=$assets?>images/dine.png"> <br><?=lang('billing')?> <img src="<?=$assets?>images/angle_down.png" class="down_img"></a>
                        <ul class="dropdown-menu">
                        	 <?php
							if($this->sma->actionPermissions('dinein_bils') ){
							?>
                            <li><a href="<?= admin_url('pos/order_biller/?type=1'); ?>"><?php echo lang("dine_in") ?> </a></li>
                            <?php
							}
							?>
							 <?php
							...
							?>
                            <li><a href="<?= admin_url('pos/order_biller/?type=2'); ?>"><?php echo lang("take_away") ?></a></li>
                            <?php
							}
							?>
							 <?php
							...
							?>
                            <li><a href="<?= admin_url('pos/order_biller/?type=3'); ?>"><?php echo lang("door_delivery") ?></a></li>
                            <?php
							}
							?>
                            <?php if($this->Settings->bbq_enable){ ?>
                            <li><a href="<?= admin_url('pos/biller_bbqtable'); ?>"><?php echo lang("BBQ") ?></a></li>
                            <li><a href="<?= admin_url('pos/biller_bbqconsolidated'); ?>"><?php echo lang("BBQ With Dine in") ?></a></li>
                            <?php } ?>
                          <li>
                             <a href="<?= admin_url('pos/reprinter'); ?>"><?php echo lang("bill_reprint") ?>
                             </a>
                          </li>
                          <?php if($this->Settings->bbq_enable){ ?>
                    ...
                    <li class="dropdown"><a data-toggle="dropdown"  href="javascript:void(0);"><img src="<?=$assets?>images/dine.png"> <br><?=lang('reports')?> <img src="<?=$assets?>images/angle_down.png" class="down_img"></a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="<?= admin_url('pos/reports/?type=1'); ?>"><?=lang('today_itemsale_report')?></a></li>
                            <?php
							}
							?>
							 <?php if($this->sma->actionPermissions('daywise_report') ) { ?>
                  <li><a href="<?= admin_url('pos/reports/?type=2'); ?>"><?=lang('daywise_report')?></a></li>
              <?php } ?>

							 <?php if($this->sma->actionPermissions('cashierwise_report') ) { ?>
                    <li><a href="<?= admin_url('pos/reports/?type=3'); ?>"><?=lang('cashierwise')?></a></li>
              <?php } ?>

						      	<li><a href="<?= admin_url('pos/reports/?type=4'); ?>"><?=lang('pos_settle_report')?></a></li>
                   <?php if($this->sma->actionPermissions('shifttime_report') ) { ?>
                        <li><a href="<?= admin_url('pos/reports/?type=5'); ?>"><?=lang('shifttime_report')?></a></li>
                  <?php } ?>
