            ...
            <tr>
                <td>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                            <td>
                                <h3 align="center" style="margin-top: -5px;line-height: 30px;"><?= lang("native_invoice") ?><br><?= lang("invoice") ?></h3>
                            </td>
                        </tr>
                    </table>
                </td>
                    ...
                    <colgroup>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="white-space: nowrap; overflow: hidden; text-overflow:ellipsis;width: 50%!important "><?= lang("native_amount") ?><br><?= lang("amount") ?></th>
                            </tr>
                        </thead>
                        <tbody>
                        <?php   
                       ...
                       $sno++;                         
                         ...
                         echo '<tr><td class="no-border text-center">'.$sno.'</td><td colspan="2" class="no-border"><span style="display: table-cell;text-align: -webkit-match-parent;text-decoration:'.$underline.'">' . ($star)  . '' . ($recipe_name) . ($bill->recipe_variant ? ' - ' . $bill->recipe_variant . '' : '') . ' </span>';                            
