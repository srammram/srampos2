                        ...
                        <tr class = "clickable">
                            ...
                            $addondetails = $this->site->getAddonByRecipeidAndOrderitemid($salesitem->recipe_id,$salesitem->id);
                             ...
                             if($pos_settings->item_comment_price_option != 0 && $salesitem->comment !='') :
                                  ?>
                                    <br> <span style="color: #1778dc;font-weight: bold;"><?=lang('comments')?></span>
                                    <br> <span style="color: red;font-weight: bold;"> <?= $salesitem->comment ?> </span><input class ="form-control comment" type="hidden" name="split[<?php echo $i;?>][comment][]" value="<?= $salesitem->comment ?>" count="<?php echo $i; ?>">
                                    <input class ="form-control numberonly comment_price" type="text" name="split[<?php echo $i;?>][comment_price][]" maxlength="5"  placeholder="Commet Price" count="<?php echo $i; ?>">
