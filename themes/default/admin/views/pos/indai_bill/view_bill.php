                    ...
                    <tfoot>
                        ...
                        if ($pos_settings->display_tax ==1 && $inv->tax_rate != 0) {
                            ...
                            if ($pos_settings->display_tax_amt==1 && $inv->tax_rate != 0) {
                                 echo '<th colspan="2" class="text-right">' .($this->sma->formatMoney($inv->total_tax)."") . '</th>';
                              }
                              echo '</tr>';*/
                            ...
                            echo '<th colspan="2" class="text-right">' . lang("total_tax") . '</th>';
