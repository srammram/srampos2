    ...
    <div id="wrapper">
        <div id="receiptData">
            ...
            <div id="receipt-data">
                ...
                <table class="table table-striped table-condensed">
                    <tbody>
                        ...
                        foreach ($rows as $row) {
                            ...
                            echo '<tr><td colspan="2" class="no-border">#' . $r . ': &nbsp;&nbsp;' . recipe_name($row->recipe_name, ($printer ? $printer->char_per_line : null)) . ($row->variant ? ' (' . $row->variant . ')' : '') . '<span class="pull-right">' . ($row->tax_code ? '*'.$row->tax_code : '') . '</span></td></tr>';
                ...
                <?= $Settings->invoice_view > 0 ? $this->gst->summary($rows, $return_rows, ($return_sale ? $inv->recipe_tax+$return_sale->recipe_tax : $inv->recipe_tax)) : ''; ?>
