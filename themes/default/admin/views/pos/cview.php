    ...
    <table class="table" cellspacing="0" border="0">
        ...
        foreach ($rows as $row): ?>
            <tr>
                ...
                <td style="text-align:left; width:180px;"><?php echo $row->recipe_name;
                    echo "<img src='" . base_url() . "index.php?module=recipe&view=gen_barcode&code=" . $row->recipe_code . "&height=25&width=150' alt='" . $row->recipe_code . "' />";
                    ?></td>
    ...
    <table class="totals" cellspacing="0" border="0">
        ...
        <tr>
            <?php if ($inv->total_tax != 0 && TAX1) { ?>
                <td style="text-align:left;"><?php echo $this->lang->line("recipe_tax"); ?></td>
