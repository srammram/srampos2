                ...
                <fieldset class="scheduler-border">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                            ...
                            <?php $billgen =  array(0 => lang('no'), 1 => lang('yes')); 
                            ?>
                            <?= form_dropdown('table_change', $billgen, $pos->table_change, 'class="form-control" id="table_change" required="required"'); ?>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group" style="padding-top: 15px;">
                            <label class="control-label" for="display_tax" style="padding: 4px 7px;"><?= lang("display_tax"); ?></label>
                            <div class="switch-field">
                            
                            <input type="radio" value="0"  id="display_tax-switch-left" class="switch_left skip" name="display_tax" <?php echo ($pos->display_tax==0) ? "checked" : ''; ?>>
                            <label for="display_tax-switch-left">OFF</label>
                            <input type="radio" value="1" id="display_tax-switch-right" class="switch_right skip" name="display_tax" <?php echo ($pos->display_tax==1) ? "checked" : ''; ?>>
                            <label for="display_tax-switch-right">ON</label>
                            </div>
                        </div>
