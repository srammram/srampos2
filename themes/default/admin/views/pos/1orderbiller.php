...
<script type="text/javascript">
    ...
    $(document).ready(function () {
       ...
       /* $('#paymentModal').on('change', '#amount_<?=$i?>', function (e) {
		...
		var ordersplit = $(this).siblings('.order_split_req').val();
		var salesid = $(this).siblings('.salesid_req').val(); 
		var grandtotal = $(this).siblings('.grandtotal_req').val(); 
		var count = $(this).siblings('.totalitems_req').val();
                    ...
                    if (data != '') {      
                     var bill_totals = '';
                       var bill_head ='' ;
                         ...
                         bill_head += '<p>'+'<?= lang('date'); ?>'+': '+data.inv.date+'<br>'+'<?= lang('sale_no_ref'); ?>'+': '+data.inv.reference_no+'<br>'+'<?= lang('sales_person'); ?>'+': '+data.created_by.first_name+' '+data.created_by.last_name;
