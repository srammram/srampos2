                            ...
                            <div class="col-xs-3 payment-list-container">
                             ...
                             <div class="col-xs-12" style="padding: 0;">
                              <div class="btn-group btn-block">
                                ...
                                <button type="button" class="btn btn-success request_bil_new" data-item="payment" id="BNO<?php echo $split_order->bill_number; ?>" style="height:40px;" <?php if($this->sma->actionPermissions('bil_payment')){ echo ''; }else{  echo 'disabled'; }  ?>>
