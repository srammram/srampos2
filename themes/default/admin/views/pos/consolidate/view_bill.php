...
if($bill->net_unit_price ==0)						   {
	 $underline ='underline';
                           ...
                           if($itemaddonamt != 0) : 
                            ...
                            echo '<td " class="no-border text-right">'.$this->sma->formatMoney($bill->net_unit_price).'';
  ...
  echo '<tr><th colspan="5" class="text-left"><small>Underlined Items are complimentary Items.
.</small></th></tr>';
						?>
    ...
    left: 0px;" class="no-print">
            ...
            if (!empty($modal)) {
                ...
                <span class="col-xs-12">
                    <a class="btn btn-block btn-warning" href="<?= admin_url('pos/consolidate/?order=1&table='.$tableid.''); ?>"><?= lang("back_to_pos"); ?></a>
                </span>
                <?php
            }
