									...
									<div class="row" style="margin-bottom: 15px;">
										...
										$(document).ready(function () {
										 ...
										 <!-- <span class="btn btn-info">10.10.00</span> -->
											...
											<a href="<?=admin_url('pos/consolidate').'/?order=1&table='.$table_id.'&split='.$split_order->split_id.'&same_customer='.$split_order->customer_id.''?>"> <button  class="btn btn-info"><?php echo lang("order_item") ?></button></a> 
											<?php } ?>
