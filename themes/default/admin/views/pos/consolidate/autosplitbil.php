...
echo admin_form_open("pos/billing_all?order_type=".$order_type."&bill_type=2&bils=".$bils."&table=".$table_id."&splits=".$split_id, $attrib);?>
                       ...
                       /* echo "<pre>";
                        ...
                        <tr>
                            ...
                            <div class="">
                                ...
                                <input type="text" name="split[<?php echo $i;?>][order_discount_input]" autocomplete="off" class="kb-pad form-control pos-input-tip order_discount_input manual-discount" id="order_discount_input_<?php echo $i; ?>" count="<?php echo $i; ?>">
                                <?php endif ; ?>
                                </div>
