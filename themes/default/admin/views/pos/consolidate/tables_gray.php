...
<head>
    ...
    <style>
		body{overflow-y: auto;padding-right: 0px;background-repeat: no-repeat;}
		#cp{padding-left: 1%;background-color: rgba(0,0,0,0.5)}
		#pos{background-color: transparent;position: relative;float: left;width: 100%;}
		.pos_header{background: #000;box-shadow: none;}
		#pos #cp #cpinner{background: transparent;}
/*table*/
		.table_sec_pills{margin: 0px 0px;border-bottom:none;}
		#exTab1 .tab-content {
			color : #333;
			padding : 5px 0px 0px;
		}
		...
		#exTab1 .nav-pills{border-bottom:none;padding-bottom: 5px;margin-top: 5px;}
		...
		#exTab1 .nav-pills>li.active>a,#exTab1 .nav-pills>li.active>a:hover, #exTab1 .nav-pills>li.active>a:focus{background-color: #c9c7c7;color: #171725;border: 1px solid #c9c7c7;}
...
/* billing */
		...
		#exTab2 .nav-pills>li.active>a,#exTab2 .nav-pills>li.active>a:hover, #exTab2 .nav-pills>li.active>a:focus{background-color: #3e3d3c;color: #fff;    border: 1px solid #3e3d3c;}
		#pos #leftdiv{padding: 7px;background-color: rgba(0,0,0,0.3);}
/*		*/
...
/*		category*/
		#category-list {border-bottom: 1px solid #4f4c4d;}
		#subcategory-list {border-bottom: 1px solid #4f4c4d;}
		#category-list .btn-prni{height: auto;min-height: 55px;border-radius: 0px;box-shadow: 0px 0px 0px 0px #543816;letter-spacing: 0.15px;margin-right: 9px;margin-bottom: 10px;background: rgb(124,65,35);background: linear-gradient(180deg, rgba(124,65,35,1) 0%, rgba(92,46,28,1) 50%, rgba(71,33,23,1) 100%);border-radius: 4px;}
		#category-list .btn-prni.active{background: rgb(206,135,78);background: linear-gradient(180deg, rgba(206,135,78,1) 0%, rgba(174,98,49,1) 50%, rgba(128,71,46,1) 100%);color: #fff!important;font-weight: 500;box-shadow: 0px 0px 0px 0px #543816;}
		#category-list .btn-prni span{width: 120px;font-size: 16px;font-weight: normal;color: #fff;text-transform: capitalize;}
		#category-list{margin: 6.1% 0px 0px;}
		#subcategory-list .btn-prni{height: 60px;min-width: 15% !important;background: rgb(51,181,255);background: linear-gradient(180deg, rgba(51,181,255,1) 0%, rgba(35,133,239,1) 50%, rgba(21,94,225,1) 100%);margin: 10px 0px;border-radius: 4px;}
		#subcategory-list .btn-prni img{display: none;}
		#subcategory-list .btn-prni span,#subcategory-list .btn-prni .sub_strong{border: none;border-radius: 0px;height: 60px;line-height: 60px;box-shadow: 0px 1px 2px 0px #f38500;font-size: 15px!important;letter-spacing: 0.5px; margin: 3px 0px 4px;background-color: transparent;box-shadow: none;color: #fff;font-weight: normal;}
		#subcategory-list .btn-prni .name_strong {
			line-height: 18px;    
			white-space: pre-wrap;
			height: auto;font-weight: normal!important;margin: 3px 0px 0px;
		}
...
/*		*/
		...
		#ajaxrecipe .btn-prni{background: rgb(96,39,66);
background: linear-gradient(180deg, rgba(96,39,66,1) 0%, rgba(56,18,83,1) 100%);border-radius:4px;height: 80px;position: relative;float: left;min-width: 15% !important;}
		...
		#ajaxrecipe .btn-prni .name_strong{word-wrap: break-word;overflow: visible;display: block;line-height: 20px;width: 100%;vertical-align: top;height: auto;line-height: 20px;text-transform: capitalize;color: #fff;font-weight: normal!important;}
		#ajaxrecipe .btn-prni .price_strong{position: absolute;bottom: 5px;left: 0px;color: #fff;font-weight: normal!important;}
...
/*		*/
		...
		#posTable .sname{font-weight: bold;font-size: 14px;color: #ffffff;line-height: 20px;}
...
.table_se_q thead tr th{background-color: #543816!important;border: 1px solid #ccc!important;}
.recipecustomize{border:none!important;background:transparent;box-shadow: none;}
.recipecustomize:focus{border:none!important;background:transparent;box-shadow: none;}
.n1 tbody tr td{text-align:center;}
#cuModalLabelname{text-align:left;margin:10px 0px;font-weight:bold;font-size:18px;}
.mod_footer{border-top:none;padding:0px 15px;}
.mod_foot{border-top:none;padding:0px 15px;}
#pr_popover_content{padding:0px 15px;}
#pr_popover_content1{padding:0px 15px;}
.unwanted_ingredients_id,.recipecustomize{height:20px!important;}
/*		new css sec*/
		.pos_header .custom_details ul li a{color: #6c6c85;}
		.down_img{right: 6px;}
		.pos_header .custom_details ul li:first-child{border-left: 1px solid #202024;}
		.pos_header .custom_details ul li{padding: 0px 25px;border-right: 1px solid #202024;}
		.pos_header .log_out .btn-default{background-color: #2a2a3d;border-color: #2a2a3d;}
		.pos_header .log_out .btn-default:hover{background-color: #6c6c85;border-color: #6c6c85;transition: all 0.25s ease-in;}
		.select2-container .select2-choice,#ui #add_item,.select2-container.select2-container-disabled .select2-choice,#seats_id,.form-control.input-sm{background: #282830;border: 1px solid #282830;padding: 0px 6px;}
		.select2-container .select2-choice > .select2-chosen,.form-control.input-sm{color: #6c6c85;}
		.select2-container .select2-choice .select2-arrow,.select2-container.select2-container-disabled .select2-choice .select2-arrow{background: #282830;}
		#ui #add_item::placeholder,#seats_id::placeholder{color: #6c6c85;}
		#ui #add_item{outline: none;box-shadow: none;border:1px solid #3a3a44; }
		.select2-drop.select2-drop-above.select2-drop-active {border-top: 1px solid #11110a!important;}
		.input-group-addon{background-color: #282830;border: 1px solid #3a3a44;}
		#left-top .select2-container{border: 1px solid #3a3a44!important;}
		#print{background-color: transparent}
		#left-middle .table > thead:first-child > tr:first-child > th {background-color: #000!important;color: #6c6c85;border-color:transparent;}
		#pos #totalTable td{color: #6c6c85;}
		#left-middle .table > tbody > tr.danger > td{background-color: #100c09;border: 1px solid #100c09;border-bottom: 1px solid;}
		.table-striped>tbody>tr:nth-child(odd)>td, .table-striped>tbody>tr:nth-child(odd)>th{background-color: #100c09;border: 1px solid #100c09;}
		.qty_number{border-color: transparent;}
		.qty_number .item-qty{background-color: transparent;color: #ffffff;border: none;vertical-align: bottom;}
		.sprice,.ssubtotal{color: #fff;}
		#totalTable{ border:none;   border-top: 1px solid #2f2729;}
		.fa-trash-o{color:#6c6c85;opacity: 1 !important; }
		.buy_getlabel{color: #fff;}
		.mCS-dark.mCSB_scrollTools .mCSB_dragger .mCSB_dragger_bar{background-color: rgba(154, 151, 151, 0.75)!important;}
		#reset, #sent_to_kitchen{height: 50px!important;}
		#reset{background-color: #322f2e;border-color: #322f2e;}
		#sent_to_kitchen{background-color: #504a44;border-color: #504a44;}
		#recipe-list, .dragscroll{background-color: rgba(0,0,0,0.3);}
/*		table list*/
		.current_table_order{background-color: rgba(0,0,0,0.6);}
		.table_list .item_list{border: 1px solid #555555;}
		.table_list hr{border-top:1px solid #555555; }
		.table_list .item_list h3,.table_list .item_list h3 span{color: #fff;font-size: 14px;font-weight: normal;}
		.split h2,.table_list .waiter{color: #c0c0d3;}
		.newsplit .btn-success{background-color: #075c07;border-color: #075c07; }
		.table_list .ul_main .li_main .btn-info{background-color:#0769a7;border-color: #0769a7; }
		.table_list .ul_main .li_main .btn-danger{background-color:#9b0504;border-color: #9b0504; }
		.table_list .ul_main .li_main .btn-warning{background-color:#d54b04;border-color: #d54b04; }
		.table_list .table_head{background-color: #3c3834;}
		.order_biller_table .bil_tab_nam{background-color: #006600;border-color:#006600 }
		 .request_bil{background-color: #0954b0;border-color:#0954b0}
		 .request_bil_new{background-color: #1e931e;border-color:#1e931e}
		 .rough-tender-payment{background-color: #ce5000!important;border-color:#ce5000!important;}
		.order-heading{color: #fff;font-weight: normal;}
/*media query*/
...
<body style="background: url(<?=base_url()?>assets/images/block_bg.jpg);">
<noscript>
...
-->
                    ...
                    <div id="cp">
                        ...
                        <div  class="col-md-12" id="popup_id_s"><div class="ad12"></div> <div class="v12"></div>
  ...
  $(document).bind( "change.filter", '#myInput', function( event ) {   
   $('#myInput').trigger('keyup');             
        ...
        $(document).on('click', '.recipe:not(".has-varients")', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "<?=admin_url('pos/getrecipeDataByCode_all')?>",
