            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                         $print_mirroring = explode(',',$printer->print_mirroring); 
                        ?>
                        <select name="print_mirroring[]" class="form-control select2" multiple>
                            <?php foreach($other_printers as $k => $row): ?>
                            <option value="<?=$row->id?>" <?php if(in_array($row->id,$print_mirroring)) { echo 'selected="selected"';} ?>><?=$row->title?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
