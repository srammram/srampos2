...
<script>
    $(document).ready(function () {
        oTable = $('#FeedBackData').dataTable({
            "aaSorting": [[2, "asc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= admin_url('reports/get_feedback_details') ?>',
           ...
           /* "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
            ...
            {column_number: 1, filter_default_label: "[<?=lang('recipe_name');?>]", filter_type: "text", data: []},
            {column_number: 2, filter_default_label: "[<?=lang('table_name');?>]", filter_type: "text", data: []},
            {column_number: 3, filter_default_label: "[<?=lang('status');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('customer_group_name');?>]", filter_type: "text", data: []},
        ], "footer");
    });
</script>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('feedback_details'); ?></h2>
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <p class="introtext"><?= lang('view_report_feedback_details'); ?></p>

                <div class="table-responsive">
                    <table id="FeedBackData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="active">
                            ...
                            <th class="text-center"><?= lang("branch"); ?></th>
