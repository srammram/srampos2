...
<!--<script>
    $(document).ready(function () {
        ...
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('api/v1/posreports/getProductsReport/?v=1'.$v) ?>',
...
<script>
    $(document).ready(function () {
        ...
        function profitLossFormat(x){
            ...
            return $symbol +formatMoney(x);
        }
        
        oTable = $('#PrRData').dataTable({
            "columns": [0] ,
            "aaSorting": [[3, "asc"]],//[[3, "desc"], [2, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?= lang('all') ?>"]],
            "iDisplayLength": <?= $Settings->rows_per_page ?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?= site_url('api/v1/posreports/getProductsReport/?v=1'.$v) ?>',
            ...
            "aoColumns": [null,null, null, {"mRender": currencyFormat,"bSearchable": false}, {"mRender": currencyFormat,"bSearchable": false}, {"mRender": profitLossFormat,"bSearchable": false}],
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-barcode"></i><?= lang('sale_items_report'); ?> <?php
            if ($this->input->post('start_date')) {
                ...
                <div id="form">
                    ...
                    <div class="row">
                       ...
                       <!-- <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("Recipe");//lang("Recipe", "suggest_product"); ?>
                                <?php echo form_input('sproduct', (isset($_POST['sproduct']) ? $_POST['sproduct'] : ""), 'class="form-control" id="suggest_recipe"'); ?>
                                <input type="hidden" name="product" value="<?= isset($_POST['product']) ? $_POST['product'] : "" ?>" id="report_recipe_id"/>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <?php echo form_input('start_date', (isset($_POST['start_date']) ? $_POST['start_date'] : ""), 'class="form-control date" autocomplete="off"  id="start_date"'); ?>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('api/v1/posreports/getProductsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('api/v1/posreports/getProductsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
