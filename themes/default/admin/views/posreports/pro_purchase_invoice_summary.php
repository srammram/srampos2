...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.home_delivery', function () {
            $offset = false;
            $url = '<?=site_url('api/v1/posreports/get_pro_purchase_invoice_summary');?>';
            GetData($url);
        });
                               ...
                               $('.dataTables_paginate').html(data.pagination);                                    
                                    ...
                                    $.each(data.report, function (a,b) 
                                    {
                                        ...
                                        // profit += (parseFloat(b.profit));
                                         ...
                                         $('#ReportData > tbody').append('<tr><td>'+$row_index+'</td><td class="text-center">'+b.reference_no+'</td><td class="text-center">'+b.quotation_req_no+'</td><td class="text-center">'+b.quotation_no+'</td><td class="text-center">'+b.po_number+'</td><td class="text-center">'+b.supplier+'</td><td class="text-center">'+b.gross+'</td><td class="text-center">'+b.item_discount+'</td><td class="text-center">'+b.bill_discount+'</td><td class="text-center">'+b.total_tax+'</td><td class="text-center">'+b.round_off+'</td><td class="text-center">'+b.grand_total+'</td></tr>');
                                        $row_index++;
                                    });

                                  $('#ReportData > tbody').append('<tr style="font-weight:bold"><td colspan="6" >Total: </td><td class="text-right">'+formatMoney(gross)+'</td><td class="text-right">'+formatMoney(item_dis)+'</td><td class="text-right">'+formatMoney(item_bill_disc)+'</td><td class="text-right">'+formatMoney(tax_amt)+'</td><td class="text-right">'+formatMoney(round_off)+'</td><td class="text-right">'+formatMoney(grand_total)+'</td></tr>');
