    ...
    $(function () {
        ...
        $('#m2bschart').highcharts({
            ...
            series: [{
                ...
                foreach ($m2bs as $r) {
                    if($r->quantity > 0) {
                        echo "['".$r->recipe_name."<br>(".$r->recipe_code.")', ".$r->quantity."],";
                    }
                }
                ?>],
                dataLabels: {
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= site_url('api/v1/posreports/best_sellers/?api-key='.$_GET['api-key']) ?>"><i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                        <li class="divider"></li>
                        <?php
                        foreach ($warehouses as $warehouse) {
                            echo '<li><a href="' . site_url('api/v1/posreports/best_sellers/' . $warehouse->id.'/?api-key='.$_GET['api-key']) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                        }
                        ?>
                    </ul>
                </li>
