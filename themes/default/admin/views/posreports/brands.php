...
<script>
    $(document).ready(function () {
        oTable = $('#PrRData').dataTable({
            ...
            'sAjaxSource': '<?= site_url('api/v1/posreports/getBrandsReport/?v=1'.$v) ?>',
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#pdf').click(function (event) {
            ...
            window.location.href = "<?=site_url('api/v1/posreports/getBrandsReport/pdf/?v=1'.$v)?>";
            return false;
        });
        $('#xls').click(function (event) {
            event.preventDefault();
            window.location.href = "<?=site_url('api/v1/posreports/getBrandsReport/0/xls/?v=1'.$v)?>";
            return false;
        });
