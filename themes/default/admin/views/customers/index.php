    ...
    $(document).ready(function () {
        ...
        var cTable = $('#CusData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                var oSettings = cTable.fnSettings();
                nRow.id = aData[1];
            ...
            "aoColumns": [null,{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null,null, null, null,  {"mRender": currencyFormat}, null, null,{"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 4, filter_default_label: "[<?=lang('ref_id');?>]", filter_type: "text", data: []},
