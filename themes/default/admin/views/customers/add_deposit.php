        ...
        <div class="modal-body">
			...
			<input type="text" name="paid_by" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <?php echo form_input('credit_amount', set_value('credit_amount'), 'class="form-control" id="credit_amount" required="required"'); ?>
                        </div>
                    </div>

                    
                    <?php if($company->customer_type=="postpaid") : ?>
                    <div class="form-group credit_days">
                        <?php echo lang('credit_days', 'credit_days'); ?>
                        <div class="controls">
