            ...
            <div class="table-responsive">
                <table id="DepData" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr class="primary">
                        ...
                        <th class="col-xs-2"><?= lang("credit_balance"); ?></th>
                        <th class="col-xs-2"><?= lang("credit_used"); ?></th>
                        <th class="col-xs-2"><?= lang("return_amount"); ?></th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            oTable = $('#DepData').dataTable({
                ...
                "aoColumns": [{"mRender": fld}, {"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat},{"mRender": currencyFormat}, null, null, {"bSortable": false}]
            });
