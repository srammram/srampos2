...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('shiftmaster_add'); ?></h2>
    </div>
...
?>
                ...
                <?php $attrib = array('data-toggle' => 'validator', 'role' => 'form','id'=>'add-cus-dis-form');
                      echo admin_form_open("shiftmaster/add/", $attrib); ?>
                      
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border"><?= lang('add') ?></legend>
                   ...
                   <div style="clear: both;height: 10px;"></div>
                    ...
                    <div class="form-group col-lg-12">
                          <?php echo form_submit('add_shiftmaster', $this->lang->line("submit"), 'class="btn btn-primary"'); ?>
                    </div>
