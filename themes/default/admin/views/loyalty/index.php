...
var oTable;
    $(document).ready(function () {
        oTable = $('#SupData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('loyalty_settings/getLoyaltys') ?>',
            ...
            "aoColumns": [null,{
                "bSortable": false,
                "mRender": checkbox
            },  null, null, null,null, null,null,{"mRender": loyalty_status},{"bSortable": false}]
        }).dtFilter([
            ...
            {column_number: 7, filter_default_label: "[<?=lang('eligibility_point');?>]", filter_type: "text", data: []},
        ], "footer");
    });
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('loyalty_settings'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon fa fa-tasks tip" data-placement="left" title="<?= lang("actions") ?>"></i></a>
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('loyalty_settings/add'); ?>" data-toggle="modal"><i class="fa fa-plus-circle"></i> <?= lang("add_loyalty"); ?></a></li>                        
                    </ul>
                </li>
            </ul>
        </div>
                ...
                <div class="table-responsive">
                    <table id="SupData" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr class="primary">
                            ...
                            <th><?= lang("start_name"); ?></th>
                            <th><?= lang("end_name"); ?></th>
                            <th><?= lang("eligibity_point"); ?></th>
                            <th><?= lang("prefix"); ?></th>
