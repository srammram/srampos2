...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_preparation'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("preparation/add")
                ?>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        echo form_dropdown('warehouse_id', $wh, '', 'class="form-control" data-placeholder="' . lang("select") . ' ' . lang("warehouse") . '" required="required" id="warehouse_id" style="width:100%;" ');
                        ?>
				...
				<!--<div class="col-md-4">
                    <div class="form-group">
                        <?= lang("Preparation Name", "Preparation Name") ?>
                        <?= form_input('preparation_name', (isset($_POST['preparation_name']) ? $_POST['preparation_name'] : ''), 'class="form-control tip" id="preparation_name" required="required"') ?>
                    </div>
                 </div>-->
                 <div class="col-md-6">   
                   <div class="form-group">
                        <?= lang("Preparation Date", "Preparation Date") ?>
                        <?= form_input('preparation_date', (isset($_POST['preparation_date']) ? $_POST['preparation_date'] : ''), 'class="form-control tip date" id="preparation_date" required="required"') ?>
                    </div>
                	...
                	<div class="form-group">
						<div class="form-group" style="margin-bottom:0;">
                            <div class="input-group wide-tip">
                                ...
                                <?php echo form_input('purchases_item', '', 'class="form-control input-lg" id="purchases_item" placeholder="' . $this->lang->line("add_Sales Items_to_order") . '"'); ?>
