...
var wastage_items={};
    var count = 1, an = 1, shipping = 0,
        ...
        audio_error = new Audio('<?= $assets ?>sounds/sound3.mp3');
		 <?php if ($inv) { ?>
        localStorage.setItem('type', '<?=$inv->type;?>');
        localStorage.setItem('date', '<?=$inv->date?>');
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12" >                
                ...
                echo admin_form_open_multipart("wastage/edit/". $id, $attrib)
                ?>                
                <div class="row">
                        ...
                        <table class="table custom_tables">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="datetime" name="date" id="date" readonly class="form-control" value="<?php echo $inv->date ?>">
