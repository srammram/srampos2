<?php defined('BASEPATH') OR exit('No direct script access allowed');// echo $inv_items;exit;?>
...
<input type="button" name="edit_store_request" value="Save" id="edit_store_request" class="process-indent btn col-lg-1 btn-sm btn-primary pull-right" autocomplete="off">
                        ...
                        <table class="table custom_tables">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <?php $st= array(); if($this->siteprocurment->hasActionPermission('process')){
					$st['process'] = lang('process');
					}
                                        if($this->siteprocurment->hasActionPermission('approve')){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" name="from_store_id" id="from_store_id" readonly class="from_store_id form-control" value="<?=$this->store_id?>">
					<input type="text" name="from_store_name" id="from_store_name" readonly class="form-control" value="<?=$this->store_name?>">
                                    ...
                                    <td>
					<input type="hidden" name="to_store_id" id="to_store_id" readonly class="form-control" value="<?=$inv->to_store_id?>">
                                    
					<input type="text" name="to_store_name" id="to_store_name" readonly class="form-control" value="<?=$this->store_name?>">
                            ...
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="store_reqTable"
                                        ...
                                        <thead>
                                        <tr>
                                            <th class="col-md-4"><?= lang('s_no');?></th>
					    <th class="col-md-4"><?= lang('code');?></th>  
                    ...
                    <table class="table custom_tables" style="table-layout:fixed">
                            <tbody>
                                <tr>                                    
                                    ...
                                    <td>
                                        <input  name="counter_name" id="counter_name" value="<?=$this->site->getTillName()?>" class="form-control" >
                                    </td>                                   
                                </tr>
                            </tbody>
                        </table>
