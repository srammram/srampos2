    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: function (request, response) {
                $.ajax({
                    type: 'get',
                    url: '<?= admin_url('procurment/returns/suggestions'); ?>',
                    dataType: "json",
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("procurment/returns/add", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
						...
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('store_id', $tr, '' , 'id="restore" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("store") . '" required="required" class="form-control input-tip select" style="width:100%;"');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="control-group table-group">
                                ...
                                <div class="controls table-controls">
                                    <table id="reTable"  class="table items  table-bordered table-condensed sortable_table" style="background:#fff">
                                        <thead>
                                        <tr>
