...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#store_transfersTable').dataTable({
            "aaSorting": [[1, "desc"], [2, "desc"]],
            "aLengthMenu": [[10, 25, 50, 100, -1], [10, 25, 50, 100, "<?=lang('all')?>"]],
            "iDisplayLength": <?=$Settings->rows_per_page?>,
            'bProcessing': true, 'bServerSide': true,
            'sAjaxSource': '<?=admin_url('procurment/store_transfers/getStore_transfers' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
	    echo admin_form_open('store_transfers/store_transfers_actions', 'id="action-form"');
	}
?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=admin_url('procurment/store_transfers/add')?>">
