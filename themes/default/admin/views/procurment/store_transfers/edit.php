    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("procurment/store_transfers/edit/".$store_transfers_id, $attrib)
                ?>
			...
			<?php echo form_submit('add_store_transfers', $this->lang->line("save"), 'id="add_store_transfers" class="btn col-lg-1 btn-sm btn-primary pull-right"'); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("Date", "date") ?>
                                <input type="datetime" name="date" id="store_transdate" readonly class="form-control" value="<?=$store_transfer->processed_on?>">
                                
                            </div>
                        </div>
                    <?php //echo '<pre>';print_R($store_transfer);?>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            echo form_dropdown('intend_request_id', $qn, $store_transfer->intend_request_id, ' class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("request_number") . '"style="width:100%;" id="store_transrequestnumber"  ');
                            ?>
                            </div>
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="intend_request_date" id="intend_request_date" readonly class="form-control" value="<?=$store_transfer->intend_request_date?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("from_store", "store_transfrom_store_id"); ?>
                                <?php
                                $fst[''] = '';
                                foreach ($stores as $store) {
                                    $fst[$store->id] = $store->name;
                                }
                                echo form_dropdown('from_store_id', $fst, $store_transfer->from_store, 'id="store_transfrom_store_id" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("from_store") . '" disabled required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        ...
                        <input type="hidden" name="warehouse" id="store_transwarehouse" value="<?php echo $Settings->default_warehouse ?>">  
                            ...
                            <div class="col-md-4">
								...
								if($this->siteprocurment->hasApprovedPermission()){
                                    ...
                                    echo form_dropdown('status', $st, $store_transfer->status, 'class="form-control input-tip" id="store_transstatus"'); ?>
