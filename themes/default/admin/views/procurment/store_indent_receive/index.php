...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('procurment/store_indent_receive/getStore_indentReceive'. ($warehouse_id ? '/' . $warehouse_id : '')) ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
    echo admin_form_open('store_indent_receive/store_request_actions', 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart-o"></i><?= lang('store_indent_receive') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                      <!--  <li>
                            <a href="<?= admin_url('procurment/store_request/add') ?>">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_store_request') ?>
                            </a>
                        </li>-->
                        <!--<li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="javascript:void(0)" class="bpo" title="<b><?= $this->lang->line("delete_store_request") ?></b>" 
                                data-content="<p><?= lang('r_u_sure') ?></p><button type='button' class='btn btn-danger' id='delete' data-action='delete'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button>" 
                                data-html="true" data-placement="left"><i class="fa fa-trash-o"></i> <?= lang('delete_store_request') ?>
                            </a>
                        </li>-->
                    </ul>
                </li>
