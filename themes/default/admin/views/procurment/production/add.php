	...
	if (reqsupplier = localStorage.getItem('reqsupplier')) {
        ...
        $("#add_item").autocomplete({
            source: function (request, response) {
                ...
                $.ajax({
                    type: 'get',
                    url: '<?= admin_url('procurment/production/suggestions'); ?>',
                    dataType: "json",
                    data: {
                        term: request.term,
...
<div class="box">
    <div class="box-header procurment-header">        
        <h2 class=""><?= lang('add_production_request'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("procurment/production/add", $attrib)
                ?>
                        	...
                        	<tbody>
                            	<tr>
                                    ...
                                    <td>
										...
										$n2 = 'PR'.str_pad($n + 1, 5, 0, STR_PAD_LEFT);  
										?>
                            ...
                            <div class="well well-sm">
                                ...
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <?php echo form_input('add_item', '', 'class="form-control input-lg" id="add_item" placeholder="' . $this->lang->line("Search Production Items") . '"'); ?>
