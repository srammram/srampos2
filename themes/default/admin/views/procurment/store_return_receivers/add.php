    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '#store_rtnrec_date', function (e) {
		 ...
		 if(localStorage.getItem('store_rtnrec_from_store_id')){
			 $store_rtnrec_from_store_id=localStorage.getItem('store_rtnrec_from_store_id');
		     $("#store_rtnrec_from_store_id").val($store_rtnrec_from_store_id);
			 load_receiver_no($store_rtnrec_from_store_id);
		 }
        if (store_rtnrec_date = localStorage.getItem('store_rtnrec_date')) {
            $('#store_rtnrec_date').val(store_rtnrec_date);
        }
		$("#receiver_id").val(localStorage.getItem('receiver_id'));
		$("#store_rtnreceivers_date").val(localStorage.getItem('store_rtnreceivers_date'));
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                              ...
                              <select name="receiver_id" id="receiver_id" class="form-control">
					           <option value=""><?=lang('select_Receiver')?></option>
					          </select>
                            </div>
						</div>
						<div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="datetime" name="store_rtnreceivers_date" id="store_rtnreceivers_date" readonly class="form-control" value="">
