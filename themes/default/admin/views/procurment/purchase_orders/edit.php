...
<script type="text/javascript">
    ...
    localStorage.setItem('po_items', JSON.stringify(<?= $json_order_items; ?>));
    <?php if($orders) { ?>
    
    localStorage.setItem('po_warehouse', '<?= $orders->warehouse_id ?>');
	localStorage.setItem('po_requestnumber', '<?= $orders->requestnumber ?>');
	localStorage.setItem('po_requestdate', '<?= $orders->requestdate ?>');
    localStorage.setItem('po_note', '<?= $orders->note; ?>');
    localStorage.setItem('po_discount', '<?= $orders->order_discount_id ?>');
    localStorage.setItem('po_tax2', '<?= $orders->order_tax_id ?>');
    localStorage.setItem('po_shipping', '<?= $orders->shipping ?>');
    <?php if ($orders->supplier_id) { ?>
        localStorage.setItem('po_supplier', '<?= $orders->supplier_id ?>');
    <?php } ?>
...
<div class="box">
    <div class="box-header procurment-header">
        <h2 class=""><?= lang('edit_purchase_orders'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">                
                ...
                echo admin_form_open_multipart("procurment/purchase_orders/edit/".$orders->id, $attrib)
                ?>
 <?php  /* echo '<pre>';
	  print_r($orders);
	  die;  */
                     ...
                     <table class="table custom_tables">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                       <input type="datetime" name="date" id="po_date" readonly class="form-control" value="<?php echo $orders->date ?>">
                                    </td>
                                    <td>
                                        <?= lang("purchase_no", "purchase_no") ?>
                                    </td>
                                    <td>                                       
                                        <input  name="reference_no" id="reference_no" readonly class="form-control" value="<?php echo $orders->reference_no ?>">
                                    </td>
                                    <td width="100px">
                                    ...
                                    <td>
                                        ...
                                        echo form_dropdown('currency', $c, (isset($orders->currency) ? $orders->currency : $Settings->default_currency), 'id="currency" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("currencies") . '" required="required" class="form-control input-tip" style="width:100%;"');
                                        ?>
                                    </td>   
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        echo form_dropdown('supplier', $sl, (isset($orders->supplier_id) ? $orders->supplier_id : 0), 'id="po_supplier" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("supplier") . '"  class="form-control input-tip select" style="width:100%;"');
                                        ?>
                                    </td>
                                    <td width="100px">
                                    ...
                                    <td width="350px">
                                        <input  name="supplier_address" id="supplier_address" readonly class="form-control" value="<?php echo $orders->supplier_address ?>">
                                    </td>                    
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        echo form_dropdown('status', $st, $orders->status, 'class="form-control input-tip" id="po_status"'); ?>
                                    </td>
                                </tr>  
                                 <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input type="datetime" name="requestdate" id="po_requestdate" readonly class="form-control" value="<?php echo $orders->requestdate; ?>">
                                    </td>
                                    <td>
                                    ...
                                    <td>                                        
                                       ...
                                       $qn[''] = '';
                                        ...
                                        echo form_dropdown('requestnumber', $qn, (isset($orders->quotation_id) ? $orders->quotation_id : '' ), ' class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("request_number") . '"style="width:100%;" id="po_requestnumber"  ');
                                        ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                       <?php
                                        ...
                                        echo form_dropdown('tax_method', $tm, $orders->tax_method, 'id="tax_method" class="form-control pos-input-tip" style="width:100%"');
                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="1">                                        
                                        <input type="text" name="note" id="po_note" class="form-control" value="<?php echo $orders->note; ?>">
                                    </td> 
                                     <td>
                                        <?= lang("bill_disc", "bill_disc") ?>
                                    </td>
                                    <td style="display: inline-block!important;">
                                       <input type="text" name="bill_disc" class="number_percentage_only form-control text-right bill_disc"  value="<?php echo $orders->bill_disc; ?>" >
                                       <input type="text" name="bill_disc_val" class="form-control text-right bill_disc_val bill_disc_val_css"  readonly="" value="<?php echo $orders->bill_disc_val; ?>" >
                                    </td>
                                </tr> 
                                <tr>                                   
                                    <td>
                                        <?= lang("shipping", "feright_chargers_shipping") ?>
                                    </td>
                                    <td>
                                       <input type="text" name="shipping_charge"  class="form-control text-right numberonly" value="<?php echo $orders->shipping; ?>" id="feright_chargers_shipping"> <!-- id="feright_chargers_shipping"  -->
                                    </td>                                 
                                    <td>
                                        <?= lang("round_off", "round_off") ?>
                                    </td>
                                    <td>
                                       <input type="text" name="round_off" id="round_off_amt"  class="form-control text-right number_minus"  value="<?php echo $orders->round_off; ?>">
                                    </td>                                                                   
                                    <td>
                                        <?= lang("net_amt", "net_amt") ?>
                                    </td>
                                    <td>
                                       <input type="text" name="bill_net_amt" readonly class="form-control text-right net_amt" value="<?php echo $orders->grand_total; ?>">
                                    </td>
                                </tr>                  
                            </tbody>
                        </table>                          
