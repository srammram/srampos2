            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <li>
                            <a href="<?= admin_url('procurment/sales/add/' . $inv->id) ?>">
                                <i class="fa fa-plus-circle"></i> <?= lang('create_invoice') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('procurment/quotes/email/' . $inv->id) ?>" data-target="#myModal" data-toggle="modal">
                        ...
                        <!--<li><a href="<?= admin_url('procurment/quotes/excel/' . $inv->id) ?>"><i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>-->
                    </ul>
                </li>
            </ul>
        </div>
        ...
        <?php if (!$Supplier || !$Customer) { ?>
            <div class="buttons">
                ...
                <div class="btn-group btn-group-justified">
                    <div class="btn-group">
                        <a href="<?= admin_url('procurment/sales/add/' . $inv->id) ?>" class="tip btn btn-primary" title="<?= lang('create_invoice') ?>">
                    ...
                    <div class="btn-group">
                        <a href="<?= admin_url('procurment/quotes/email/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal" class="tip btn btn-info tip" title="<?= lang('email') ?>">
                    ...
                    <div class="btn-group">
                        <a href="javascript:void(0)" class="tip btn btn-danger bpo" title="<b><?= $this->lang->line("delete_quote") ?></b>"
