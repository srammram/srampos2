...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (!localStorage.getItem('store_rtn_items')) {
            localStorage.setItem('store_rtn_customer', <?=$this->input->get('customer');?>);
        }
        <?php } ?>
        <?php //if ($Owner || $Admin) { ?>
        if (!localStorage.getItem('store_rtn_date')) {
            $("#store_rtn_date").datetimepicker({
		...
		$(document).on('change', '#store_rtn_type', function (e) {
            localStorage.setItem('store_rtn_type', $(this).val());
        });
        if (store_rtn_biller = localStorage.getItem('store_rtn_type')) {
            $('#store_rtn_type').val(store_rtn_type);
        }
        if (!localStorage.getItem('store_rtn_tax2')) {
            localStorage.setItem('store_rtn_tax2', <?=$Settings->default_tax_rate2;?>);
        }
        ItemnTotals();
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_store_returns'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("procurment/store_returns/add", $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                    	...
                    	<div class="col-md-4">
                            <div class="form-group">
                                <?= lang("Date", "date") ?>
                                <input type="datetime" name="date" id="store_rtn_date" readonly class="form-control" value="<?php echo date('Y-m-d H:i:s') ?>">
                        ...
                        <input type="hidden" name="request_type" id="store_rtn_type" value="<?php echo 'return' ?>">
                        <!--<div class="col-md-4">
                            <div class="form-group">
                                <?= lang("supplier", "store_rtn_supplier"); ?>
                                <input type="hidden" name="supplier" value="" id="store_rtn_supplier" class="form-control" required="required" style="width:100%;" placeholder="<?= lang("select") . ' ' . lang("supplier") ?>">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('from_store_id', $fst, (isset($_POST['from_store_id']) ? $_POST['from_store_id'] : ''), 'id="store_rtn_from_store_id" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("from_store") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('to_store_id', $tst, (isset($_POST['to_store_id']) ? $_POST['to_store_id'] : $this->siteprocurment->defaultStores()), 'id="store_rtn_to_store_id" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("to_store") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                            
                            <input type="hidden" name="warehouse" id="store_rtn_warehouse" value="<?php echo $Settings->default_warehouse ?>">  
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('status', $st, '', 'class="form-control input-tip" id="store_rtn_status"'); ?>
                        ...
                        <div class="col-sm-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_store_returns', $this->lang->line("submit"), 'id="add_store_returns" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
