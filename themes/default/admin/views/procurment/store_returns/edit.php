...
<script type="text/javascript">
    ...
    <?php } ?>
		...
		$(document).ready(function () {        $(document).on('change', '#podate', function (e) {
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('edit_store_returns'); ?></h2>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <?= lang("Request_number", "store_rec_requestnumber"); ?>
							   <input type="datetime"   readonly class="form-control" value="<?php echo $sr->req_reference_no ?>">
                            </div>
                    ...
                    <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("store_returns_receivers_ref", "store_returns_receivers_ref") ?>
                                <input type="datetime"   readonly class="form-control" value="<?php echo $sr->reference_no ?>">
                       ...
                       <div class="col-md-4">
                            <div class="form-group">
                                ...
                                echo form_dropdown('from_store_id', $fst, (isset($_POST['from_store_id']) ? $_POST['from_store_id'] : $sr->from_store), 'id="store_rec_from_store_id" disabled class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("from_store") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4" >
                            <div class="form-group">
                                ...
                                echo form_dropdown('to_store_id', $tst, (isset($_POST['to_store_id']) ? $_POST['to_store_id'] : $sr->to_store), 'id="store_rec_to_store_id" disabled class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("to_store") . '" required="required" style="width:100%;" ');
                                ?>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('status', $st, $sr->status, 'class="form-control input-tip" id="store_rec_status"'); ?>
