...
<div class="modal-dialog modal-lg" style="width: 1159px !important;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><?=lang('purchase_return')?> <?=$orders->reference_no?></h4>
        </div>
          ...
          <div class="table-responsive">
            <table class="custom_tables">
                ...
                <tr>
                    ...
                    <td colspan=2 ><?=lang('invoice_no')?>: </td>
                    <td colspan=2  class="td-value"><?=$orders->invoice_no?></td>
                    
                    <td colspan=2 ><?=lang('invoice_date')?>: </td>
                    <td colspan=2  class="td-value"><?=$orders->invoice_date?></td>
                ...
                <tr>
                    ...
                    <table id="ItemData" class="table table-bordered table-condensed table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <td><?=$row['row']->received_quantity?></td>
