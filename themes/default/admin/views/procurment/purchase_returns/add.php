...
<div class="box">
    <div class="box-header procurment-header">
        <h2 class=""><?= lang('add_purchase_return'); ?></h2>
    </div>
                    ...
                    <table class="table custom_tables">
                            <tbody>
                                <tr>                                    
                                    ...
                                    <td width="150px">
                                        <input  name="logged_by" id="logged_by" readonly tabindex=-1 class="form-control" value="<?= $this->session->userdata('username') ?>">
                                    </td>
                                     <td width="100px">                                    
                                    </td>
                                    <td width="100px">                                    
...
$(document).on('change', '#pi_requestnumber', function(){
	...
	$.ajax({
		type: 'get',
		url: '<?= admin_url('procurment/purchase_returns/purchase_invoice_list'); ?>',
		dataType: "json",
		data: {
		...
		success: function (data) {
			...
			console.log(data.value['purchase_invoicesitem'])
			...
			$('#pi_supplier').change();
			$('#invoice_date').val(localStorage.getItem('pi_requestdate'));
