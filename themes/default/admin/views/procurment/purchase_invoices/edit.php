...
<script type="text/javascript">
    ...
    localStorage.setItem('pi_items', JSON.stringify(<?= $json_inv_items; ?>));
...
<div class="box">
    ...
    <div class="box-content">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("procurment/purchase_invoices/edit/".$inv->id, $attrib)
                ?>
                <div class="row">
			...
			<?php echo form_submit('add_purchase_invoices', $this->lang->line("save"), 'id="add_purchase_orders" class="btn col-lg-1 btn-sm btn-primary pull-right"'); ?>
                                <button type="button" class="btn col-lg-1 btn-sm btn-danger pull-right" style="display: none;margin-right:15px;height:30px!important;font-size: 12px!important" id="reset"><?= lang('reset') ?></button>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        echo form_dropdown('currency', $c, (isset($inv->currency) ? $inv->currency : $Settings->default_currency), 'id="currency" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("currencies") . '" required="required" class="form-control input-tip" style="width:100%;"');
                                        ?>
                                    </td>                                    
                                </tr>
                                <tr>
					...
					<div class="input-group">
                                        ...
                                        echo form_dropdown('supplier', $sl, (isset($inv->supplier_id)) ? $inv->supplier_id : 0, 'id="pi_supplier" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("supplier") . '"  class="form-control input-tip select" style="width:100%;"');
                                        ?>
					<div class="input-group-addon no-print" style="padding: 2px 5px;">
						...
						<i class="fa fa-2x fa-plus-square" id="addIcon1"></i>
                                    ...
                                    <td width="350px">
                                        <input  name="supplier_address" id="supplier_address" readonly tabindex=-1 class="form-control" value="<?=$inv->supplier_address?>">
                                    </td>                                    
                                    <td>
                                    ...
                                    <td>                                        
                                        ...
                                        echo form_dropdown('status', $st,$inv->status, 'class="form-control input-tip" id="pi_status"'); ?>
                                    </td>                                    
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <?php
                                           $po[''] = '';
                                            ...
                                            echo form_dropdown('po_number', $po, (isset($inv->po_number) ? $inv->po_number : '' ), ' class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("po_number") . '"style="width:100%;" id="po_number"  ');
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        echo form_dropdown('stock_type', $st, $inv->stock_type, 'id="tax_method" class="form-control pos-input-tip" style="width:100%"');
                                ...
                                <tr>
                                    ...
                                    <td>                                        
                                        <input type="datetime" name="invoice_date" id="invoice_date"  class="form-control" value="<?php echo date('Y-m-d') ?>">
                                    </td>
                                    <td>
                                        <?= lang("invoice_no", "invoice_no") ?>
                                    </td>
                                    <td>                                        
                                        <input type="datetime" name="invoice_no" id="invoice_no"  class="form-control" value="<?=$inv->invoice_no?>">
                                    </td>
 ...
 <td>
                                    ...
                                    <td> 
                                       <input type="text" name="invoice_amt" id="invoice_amt" class="form-control numberonly" value="<?=$inv->invoice_amt?>">
                                    </td>								
                                    <td>
                                        <?= lang("remarks_note", "ponote") ?>
                                    </td>
                                    <td colspan="3">                                        
                                        <input type="text" name="note" id="pi_note" class="form-control" value="<?=$inv->note?>">
                                    </td>                                                                   
                                 ...
                                 <tr>   
                                    ...
                                    <td style="display: inline-block!important;">
                                       <div class="col-sm-6" style="padding: 0;"><input type="text" name="bill_disc" class="number_percentage_only form-control text-right bill_disc"  value="<?=$inv->bill_disc?>" style="display: inline-block!important;"></div>
                                       <div class="col-sm-6"><input type="text" name="bill_disc_val" class="form-control text-right bill_disc_val"  readonly="" tabindex=-1 value="<?=$inv->bill_disc_val?>" style="display: inline-block!important;"></div>
                                    </td>                              
                                    <td>
                                        <?= lang("shipping_charge", "shipping_charge") ?>
                                    </td>
                                    <td>
                                       <input type="text" name="shipping_charge" id="feright_chargers_shipping"  class="form-control text-right numberonly" value="<?=$inv->shipping?>">
                                    </td>
                                    ...
                                    <td>
                                       <input type="text" name="round_off" id="round_off_amt"  class="form-control text-right number_minus"  value="<?=$inv->round_off?>">
                                    </td>
								...
								<tr>
								 <td>
                                    ...
                                    <td>
                                       <input type="text" name="bill_net_amt" readonly tabindex=-1 class="form-control text-right net_amt" value="<?=$inv->grand_total?>">
                                    </td>
                                </tr>      
                            </tbody>
                        </table>                          
                        ...
                        <input type="hidden" name="warehouse" id="pi_warehouse" value="<?php echo $Settings->default_warehouse ?>">  
                            ...
                            <div class="col-md-4">
								...
								if($this->siteprocurment->GETaccessModules('purchase_invoices_approved')){
                                    ...
                                    echo form_dropdown('status', $st, (isset($inv->status) ? $inv->po_number : '' ), 'class="form-control input-tip" id="pi_status"'); ?>
                        ...
                        <table class="table total_item_qty_tables" style="padding: 4px;border-top: none!important">
                            <tbody>
                                <tr>                                    
                                    ...
                                    <td>
                                        <input  name="total_no_items" id="total_no_items" value="<?=$inv->no_of_items?>"  readonly tabindex=-1 class="form-control">
                                    </td>       
                                    <td width="50%"></td>                                                                 
                                    <td >
                                        <?= lang("gross", "gross") ?>
                                    ...
                                    <td class="text-right">
                                        <input  name="final_gross_amt" id="final_gross_amt" value="<?=$inv->total?>" readonly tabindex=-1 class="form-control text-right">
                                    </td>
                                </tr>
                                 <tr>                                    
                                    <td width="150px">
                                    ...
                                    <td width="150px">
                                        <input  name="total_no_qty" id="total_no_qty" value="<?=$inv->no_of_qty?>"  readonly tabindex=-1 class="form-control ">
                                    </td>
                                    <td width="50%"></td>                                                                 
                                    <td >
                                    ...
                                    <td class="text-right">
                                        <input  name="item_disc" id="item_disc" value="<?=$inv->item_discount?>" readonly tabindex=-1 class="form-control text-right">
                                    </td>
                                </tr>
                                 <tr>                                    
                                    <td width="150px"></td>
				    ...
				    <?php $subtotal = $inv->total-$inv->item_discount-$inv->bill_disc_val;?>
                                    <td class="text-right">
                                        <input  name="sub_total" id="sub_total" value="<?=$subtotal?>" readonly tabindex=-1 class="form-control text-right">
                                    </td>
                                </tr>    
                                <tr> 
                                    <td width="150px"></td>
                                    ...
                                    <td class="text-right">
                                        <input  name="tax" id="tax" value="<?=$inv->total_tax?>" readonly tabindex=-1 class="form-control text-right">
                                    </td>
                                </tr>                                                                                                       
                                <tr> 
                                    <td width="150px"></td>
                                    ...
                                    <td class="text-right">
                                        <input  name="freight" id="freight" readonly tabindex=-1 value="<?=$inv->freight?>" class="form-control text-right">
                                    </td>
                                </tr>                                                                                                       
                                <tr> 
                                    <td width="150px"></td>
                                    ...
                                    <td class="text-right">
                                        <input  name="round_off" id="round_off" value="<?=$inv->round_off?>" readonly tabindex=-1 class="form-control text-right">
                                    </td>
                                </tr>                                                                                                       
                                <tr> 
                                    <td width="150px"></td>
                                    ...
                                    <td class="text-right">
                                        <input  name="net_amt" value="<?=$inv->grand_total?>" readonly tabindex=-1 class="form-control text-right net_amt">
                                    </td>
                                </tr>                                                                                                       
                            </tbody>
                        </table>                                    
                                    ...
                                    <div class="col-md-6" style="padding-bottom: 10px;">
                                        <div class="form-group">
                                           ...
                                           <div class="col-md-7">
                                            ...
                                            echo form_dropdown('order_tax', $tr, (isset($inv->order_tax) ? $inv->order_tax : '' ), 'id="potax2" class="form-control input-tip select" style="width:100%;"');
                                            ?>
											</div>
                                        </div>
                                    </div>
                    ...
                    <table class="table custom_tables">
                            <tbody>
                                <tr>                                    
                                    ...
                                    <td width="150px">
                                        <input  name="logged_by" id="logged_by" readonly class="form-control" value="<?= ucwords($this->session->userdata('username')); ?>">
                                    </td>
                                     <td width="100px">                                    
                                    </td>
                                    <td width="100px">                                    
...
$(document).ready(function(e) {        
    ...
    //$('#tax_method').val(localStorage.getItem('tax_method'));
     ...
     $round_off = $('#round_off_amt').val();
    if ($round_off!=0) {        
    localStorage.setItem('round_off',$round_off);    
    }

    $freight = $('#feright_chargers_shipping').val();
...
$(document).on('change', '#pi_requestnumber', function(){
	...
	$.ajax({
		type: 'get',
		url: '<?= admin_url('procurment/purchase_invoices/purchase_invoices_list'); ?>',
		dataType: "json",
		data: {
                    ...
                    <div class="col-md-6 col-sm-6">
                        ...
                        <?php if ($Settings->tax1) { ?>
                            ...
                            <div class="form-group all">
                                <?= lang("tax_method", "mtax_method"). $inv->tax_method; ?>
                                <?php 
                                $tm = array('0' => lang('inclusive'), '1' => lang('exclusive'));
                                echo form_dropdown('tax_method', $tm, (isset($inv->tax_method) ? $inv->tax_method : '' ), 'class="form-control select" id="mtax_method" placeholder="' . lang("select") . ' ' . lang("tax_method") . '" style="width:100%"')
                                ?>
                            </div>
                        <?php } ?>
                    </div>
