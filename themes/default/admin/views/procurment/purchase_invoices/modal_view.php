            ...
            <?php if (!$Supplier || !$Customer) { ?>
                <div class="buttons">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('purchases_order/email/' . $inv->id) ?>" data-toggle="modal" data-target="#myModal2" class="tip btn btn-primary" title="<?= lang('email') ?>">
                        ...
                        <div class="btn-group">
                            <a href="<?= admin_url('purchases_order/edit/' . $inv->id) ?>" class="tip btn btn-warning sledit" title="<?= lang('edit') ?>">
                        ...
                        <div class="btn-group">
                            <a href="#" class="tip btn btn-danger bpo" title="<b><?= $this->lang->line("delete_purchases_order") ?></b>"
                                ...
                                <span class="hidden-sm hidden-xs"><?= lang('delete_purchases_order') ?></span>
                            </a>
                        </div>
                    </div>
                </div>
