...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#purchase_invoicesTable').dataTable({
            ...
            'sAjaxSource': '<?=admin_url('procurment/purchase_invoices/getPurchase_invoices' . ($warehouse_id ? '/' . $warehouse_id : ''))?>',
            ...
            "aoColumns": [{"bSortable": false,"mRender": checkbox}, {"mRender": fld}, null,null,null, null, {"mRender": currencyFormat},{"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat},  {"mRender": row_status},{"bSortable": false,"mRender": procurment_attachment},  {"bSortable": false}],
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-star"></i><?=lang('purchase_invoices') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')';?>
        </h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?=admin_url('procurment/purchase_invoices/add')?>">
