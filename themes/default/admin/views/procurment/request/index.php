...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#QUData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('procurment/request/getRequest') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i
                class="fa-fw fa fa-heart-o"></i><?= lang('quotation_request') . ' (' . ($warehouse_id ? $warehouse->name : lang('all_warehouses')) . ')'; ?>
        </h2>
	    <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('procurment/request/add') ?>">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_quotation_request') ?>
                            </a>
                        </li>
