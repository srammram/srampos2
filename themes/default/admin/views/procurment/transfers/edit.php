...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        localStorage.setItem('tonote', '<?= $transfer->note; ?>');
        ...
        $("#add_item").autocomplete({
            //source: '<?= admin_url('procurment/transfers/suggestions'); ?>',
            source: function (request, response) {
                ...
                $.ajax({
                    type: 'get',
                    url: '<?= admin_url('procurment/transfers/suggestions'); ?>',
                    dataType: "json",
                    data: {
                        term: request.term,
        ...
        $(window).bind('beforeunload', function (e) {
            $.get('<?= admin_url('procurment/welcome/set_data/remove_tols/1'); ?>');
            if (count > 1) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("procurment/transfers/edit/" . $transfer->id, $attrib)
                ?>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
								...
								$post['process'] = lang('process');
								if($this->siteprocurment->GETaccessModules('')){
									$post['approved'] = lang('approved');	
