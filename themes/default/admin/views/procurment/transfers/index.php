...
<script>
    ...
    $(document).ready(function () {
        oTable = $('#TOData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('procurment/transfers/getTransfers') ?>',
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('procurment/transfers/add') ?>">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="javascript:void(0)" class="bpo" title="<b><?= $this->lang->line("delete_transfers") ?></b>"
