...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            ...
            // source: '<?= admin_url('order_purchases/suggestions'); ?>',
            source: function (request, response) {
                $.ajax({
                    type: 'get',
                    url: '<?= admin_url('order_purchases/suggestions'); ?>',
                    dataType: "json",
                    data: {
                        term: request.term,
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("order_purchases/add", $attrib)
                ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('invoice_no', (isset($_POST['invoice_no']) ? $_POST['invoice_no'] : ""), 'class="form-control input-tip"  required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("invoice_date", "invoice_date"); ?>
                                    <?php echo form_input('invoice_date', (isset($_POST['invoice_date']) ? $_POST['invoice_date'] : ""), 'class="form-control input-tip datetime" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="clearfix"></div>
                        <?php if ($Owner || $Admin) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("purchase_order_no", "purchase_order_no"); ?>
                                    <?php echo form_input('purchase_order_no', (isset($_POST['purchase_order_no']) ? $_POST['purchase_order_no'] : ""), 'class="form-control input-tip podate" required="required"'); ?>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("purchase_order_date", "purchase_order_date"); ?>
                                    <?php echo form_input('purchase_order_date', (isset($_POST['purchase_order_date']) ? $_POST['purchase_order_date'] : ""), 'class="form-control input-tip datetime" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        <div class="clearfix"></div>
                                    ...
                                    <table id="poTable"
                                        ...
                                        <tr>
                                            <th class="col-md-4"><?= lang('product') . ' (' . lang('code') .' - '.lang('name') . ')'; ?></th>
                                             <th class="col-md-2"><?= lang('Batch No'); ?></th>
                                            <?php
                                            ...
                                            <?php
                                            if ($Settings->tax1) {
                                                echo '<th class="col-md-1">' . $this->lang->line("Tax Method") . '</th>';
												 echo '<th class="col-md-1">' . $this->lang->line("Tax amount") . '</th>';
                                            }
                                            ?>
