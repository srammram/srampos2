...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#DOData').dataTable({
            ...
            "aoColumns": [null,{"bSortable": false,"mRender": checkbox},null, {"mRender": fld}, null, null, null, null, {"mRender": ds}, {"bSortable": false,"mRender": attachment}, {"bSortable": false}]
        }).fnSetFilteringDelay().dtFilter([
            {column_number: 3, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('do_reference_no');?>]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('sale_reference_no');?>]", filter_type: "text", data: []},
