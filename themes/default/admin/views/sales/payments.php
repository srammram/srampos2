        ...
        <div class="modal-body">
            <div class="table-responsive">
                <table id="CompTable" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <thead>
                    <tr>
                        <th style="width:30%;"><?= $this->lang->line("Bill_id"); ?></th>
                        ...
                        <th style="width:15%;"><?= $this->lang->line("total_tax"); ?></th>
                        <th style="width:15%;"><?= $this->lang->line("discount"); ?></th>
                        <th style="width:15%;"><?= $this->lang->line("sub_total"); ?></th>
                    ...
                    <?php if (!empty($payments)) {
                        foreach ($payments as $payment) { ?>
                            <tr class="row<?= $payment->id ?>">
                                <td align="center"><?= lang($payment->id); ?>
                                <td><?= $this->sma->hrld($payment->date); ?></td>
                                <td><?= $payment->reference_no; ?></td>
                                <td><?= $payment->total; ?></td>
                                <td><?= $payment->total_tax; ?></td>
