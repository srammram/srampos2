    ...
    $(document).ready(function () {
        oTable = $('#SLData').dataTable({
            ...
            'fnRowCallback': function (nRow, aData, iDisplayIndex) {
                ...
                nRow.className = "invoice_link1 re"+aData[14];
                $index = oSettings._iDisplayStart+parseInt(iDisplayIndex) +parseInt(1) ;
                $("td:first", nRow).html($index);
                //if(aData[7] > aData[9]){ nRow.className = "product_link warning"; } else { nRow.className = "product_link"; }
                return nRow;
            },
            "aoColumns": [null,{"bSortable": false,"mRender": checkbox}, null,null,{"mRender": fld}, null, null, null, {"mRender": row_status}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": currencyFormat}, {"mRender": pay_status}, {"bSortable": false,"mRender": attachment}, {"bVisible": false}, {"bSortable": false}],
            ...
            {column_number: 3, filter_default_label: "[<?=lang('order_type');?>]", filter_type: "text", data: []},
            {column_number: 4, filter_default_label: "[<?=lang('date');?> (yyyy-mm-dd)]", filter_type: "text", data: []},
            {column_number: 5, filter_default_label: "[<?=lang('reference_no');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="SLData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th></th>
                            <th style="width:80px; text-align:center;"><?= lang("view_payments"); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
