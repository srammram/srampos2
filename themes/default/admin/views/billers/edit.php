...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        ...
        <?php $attrib = array('data-toggle' => 'validatorr', 'role' => 'form','id'=>'edit-counter');
        //echo admin_form_open_multipart("billers/edit/" . $biller->id, $attrib); ?>
        <form data-url="<?=admin_url('billers/edit/' . $biller->id);?>" role="form" id="edit-counter" enctype="multipart/form-data" method="post" accept-charset="utf-8">
        <div class="modal-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        echo form_dropdown('logo', $biller_logos,$biller->logo, 'class="form-control select" id="biller_logo" data-bv-notempty="true" required="required"'); ?>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?= lang("phone", "phone"); ?>
                        <input type="tel" name="phone" class="form-control" required="required" maxlength="30" id="phone" onkeypress="return Validate(event);" value="<?= $biller->phone ?>"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        if ($this->Settings->indian_gst) {
                            ...
                            echo form_dropdown('state', $states, $biller->state, 'class="form-control select" id="state"');
                        } else {
                    ...
                    <div class="form-group">
                        ...
                        <?php echo form_input('local_lang_name', $biller->local_lang_name, 'class="form-control" id="local_lang_name"'); ?>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?php echo form_input('postal_code', $biller->postal_code, 'class="form-control numberonly" maxlength="6" id="postal_code"'); ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <?= lang("local_lang_address", "local_lang_address"); ?>
                        <?php echo form_input('local_lang_address', $biller->local_lang_address, 'class="form-control" id="local_lang_address"'); ?>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
        ...
        <div class="modal-footer">
            <input type="hidden" name="edit_biller" value="<?=lang('edit_biller')?>">
