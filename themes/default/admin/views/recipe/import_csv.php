...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('import_recipe_by_csv'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <div><a href="<?=admin_url('recipe/download_sample')?>" class="btn btn-primary pull-right"><i class="fa fa-download"></i>&nbsp<?=lang('Download_sample_file')?></a></div>
                <?php
                $attrib = array('class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form');
                echo admin_form_open_multipart("recipe/import_csv", $attrib)
                ?>
                <div class="row">
                    <div class="col-md-12">
