        ...
        <div class="modal-body">
            ...
            <div class="row">
                ...
                <table class="table table-bordered table-condensed">
                            ...
                            foreach ($stock_count_items as $row): ?>
                                <tr>
                                    ...
                                    <td style="text-align:left;">
                                        <?= $row->recipe_code.' - '.$row->recipe_name . ($row->recipe_variant ? ' (' . $row->recipe_variant . ')' : ''); ?>
                                    </td>
                    ...
                    <?php
                    if ($adjustment) {
                        echo '<a href="'.admin_url('recipe/view_adjustment/'.$adjustment->id).'" class="btn btn-primary btn-block no-print" data-toggle="modal" data-target="#myModal2">'.lang('view_adjustment').'</a>';
                    } elseif (!empty($stock_count_items)) {
                        echo '<a href="'.admin_url('recipe/add_adjustment/'.$stock_count->id).'" class="btn btn-primary btn-block no-print">'.lang('add_adjustment').'</a>';
                    }
                    ?>
                </div>
            </div>
