    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart('recipe/finalize_count/'.$stock_count->id, $attrib);
                                ...
                                <div class="panel-body">
                                    ...
                                    <span class="text-success">
                                        ...
                                        <span class="text-info">
                                            (<?= lang("recipe_code") . ', ' . lang("recipe_name") . ', ' . lang("variant") . ', ' . lang("expected") . ', ' . lang("counted"); ?>)
                                        </span>
                                        <?= lang("csv3"); ?><br>
    ...
    $(document).ready(function() {
        ...
        $('#download_csv').click(function(e) {
            ...
            if (type) {
                ...
                $('#stForm').attr('action', site.base_url+'recipe/download_stock_count_csv').submit();
                // $('#csv_file').attr('required', 'required');

                // $.post(site.base_url+'recipe/download_stock_count_csv', {type: type, categories: categories, barnds: brands}, function(data, textStatus, xhr) {
