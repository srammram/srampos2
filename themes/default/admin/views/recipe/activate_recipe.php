...
<div class="modal-dialog">
    <div class="modal-content" style="width:68%!important">
        ...
        echo admin_form_open("recipe/activate/" . $recipe->id, $attrib); ?>
        <div class="modal-body">
            <?php 
            $user_lang = $this->Settings->user_language;
            /*$user_lang = $this->Settings->user_language;
                if($user_lang == 'english'){  
                   $recipe =  $recipe->name;
                }
                else{
                    $recipe =  $recipe->khmer_name;
                }*/
              /*var_dump($user_lang);*/
            ?>
...
<!-- no_image.png -->
            <p><?php echo sprintf(lang('activate_heading'), $recipe->name); ?></p>
        ...
        <div class="modal-footer">
            <input type="submit" name="activate" value="<?=lang('activate');?>" class="btn btn-primary" autocomplete="off">
            <!-- <?php echo form_submit('deactivate', lang('activate'), 'class="btn btn-primary"'); ?> -->
        </div>
    </div>
    <?php echo form_close(); ?>
</div>
