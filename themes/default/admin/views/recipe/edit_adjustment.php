...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: '<?= admin_url('recipe/qa_suggestions'); ?>',
            minLength: 1,
            autoFocus: false,
            delay: 250,
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("recipe/edit_adjustment/".$adjustment->id, $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin) { ?>
                            ...
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                    <div class="input-group wide-tip">
                                        ...
                                        <?php echo form_input('add_item', '', 'class="form-control input-lg" id="add_item" placeholder="' . lang("add_recipe_to_order") . '"'); ?>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
