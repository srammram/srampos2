...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("recipe/update_price", $attrib); ?>
        <div class="modal-body">
            <p><?= lang('enter_info'); ?></p>
            <div class="row">
                <div class="col-md-12">
                    <div class="well well-small">
                        <a href="<?php echo base_url(); ?>assets/csv/sample_recipe_price.csv"
                           class="btn btn-primary pull-right"><i
                           class="fa fa-download"></i> <?= lang("download_sample_file") ?></a>
                           <span class="text-warning"><?= lang("csv1"); ?></span><br/><?= lang("csv2"); ?> <span
                           class="text-info">(<?= lang("recipe_code") . ', ' . lang("recipe_price"); ?>
                           )</span> <?= lang("csv3"); ?>
