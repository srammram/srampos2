...
<script>
    $(document).ready(function () {
        oTable = $('#dmpData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('recipe/getadjustments/'.($warehouse ? $warehouse->id : '')); ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
        echo admin_form_open('recipe/adjustment_actions', 'id="action-form"');
    }
?>
<div class="box">
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('recipe/add_adjustment') ?>">
                                <i class="fa fa-plus-circle"></i> <?= lang('add_adjustment') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('recipe/add_adjustment_by_csv') ?>">
                ...
                <?php if (!empty($warehouses)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('recipe/quantity_adjustments') ?>"><i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($warehouses as $warehouse) {
                                echo '<li><a href="' . admin_url('recipe/quantity_adjustments/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
