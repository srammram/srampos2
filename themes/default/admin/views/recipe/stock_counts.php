...
<script>
    ...
    $(document).ready(function () {
        ...
        oTable = $('#STData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('recipe/getCounts'.($warehouse_id ? '/'.$warehouse_id : '')) ?>',
...
<?php if ($Owner || $GP['bulk_actions']) {
    echo admin_form_open('recipe/count_actions'.($warehouse_id ? '/'.$warehouse_id : ''), 'id="action-form"');
} ?>
<div class="box">
    <div class="box-header">
        ...
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a href="<?= admin_url('recipe/count_stock') ?>" class="tip" data-placement="top" title="<?= lang("count_stock") ?>">
                ...
                <?php if (!empty($warehouses)) { ?>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                            <li><a href="<?= admin_url('recipe/stock_counts') ?>"><i class="fa fa-building-o"></i> <?= lang('all_warehouses') ?></a></li>
                            <li class="divider"></li>
                            <?php
                            foreach ($warehouses as $warehouse) {
                                echo '<li><a href="' . admin_url('recipe/stock_counts/' . $warehouse->id) . '"><i class="fa fa-building"></i>' . $warehouse->name . '</a></li>';
                            }
                            ?>
                        </ul>
                    </li>
