                                                                    ...
                                                                    <div class="col-md-12">
                                                                        ...
                                                                        <div class="no">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <?php $checked = (in_array($warehouse->id,$assigned_stores))?'checked="checked"':"";?>
                                                                                    <div class="col-md-12"><label><input type="checkbox" name="warehouse[]" value="<?=$warehouse->id?>" <?=$checked?>><?=$warehouse->name?></label></div>
                                                                                <?php }
                                                                            ...
                                                                            <!--<div class="form-group max-discount">
                                                                                <?= lang("Max_discount_percentage", "max_discount_percentage"); ?>
                                                                                <?php if($user->max_discount_percent==0) $user->max_discount_percent=''; ?> 
                                                                                <?php //if($_POST['max_discount_percent']==0) $_POST['max_discount_percent']=''; ?> 
                                                                                 <input type="text" id="max_discount_percent" maxlength=3 name="max_discount_percent" value="<?=(isset($_POST['max_discount_percent']) ? $_POST['max_discount_percent'] : $user->max_discount_percent)?>" class="form-control numberonly"/>
                                                                            </div>-->
                                                                            <?php } ?>
                                                                        </div>
                                                                    </div>
