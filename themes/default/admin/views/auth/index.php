<script>
    $(document).ready(function () {
		...
		$index = oSettings._iDisplayStart+parseInt(iDisplayIndex) +parseInt(1) ;
            ...
            {column_number: 3, filter_default_label: "[<?=lang('first_name');?>]", filter_type: "text", data: []},
            ...
            {column_number: 7, filter_default_label: "[<?=lang('award_points');?>]", filter_type: "text", data: []},
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('user_number'); ?></th>
                            <th class="col-xs-2"><?php echo lang('first_name'); ?></th>
                            <th class="col-xs-2"><?php echo lang('branch'); ?></th>
