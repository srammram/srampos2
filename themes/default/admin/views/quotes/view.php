...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-file"></i><?= lang("quote_order_no") . '. ' . $inv->id; ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <?php } ?>
                        <li>
                            <a href="<?= admin_url('quotes/payments/' . $inv->id) ?>" data-target="#myModal" data-toggle="modal">
                                <i class="fa fa-money"></i> <?= lang('view_payments') ?>
                            </a>
                        </li>
                        <li>
                            <a href="<?= admin_url('quotes/add_payment/' . $inv->id) ?>" data-target="#myModal" data-toggle="modal">
                        ...
                        <li>
                            <a href="<?= admin_url('quotes/email/' . $inv->id) ?>">
