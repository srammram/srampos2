...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('balance_production'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("production/balance_edit/".$production->id, $attrib)
                ?>
                ...
                <div class="col-md-4">
                 ...
                 <div class="col-md-4">   
                   <div class="form-group">
                        ...
                        <?= form_input('production_date', (isset($_POST['production_date']) ? $_POST['production_date'] : $production->production_date), 'class="form-control tip totay_date" id="production_date" required="required" readonly') ?>
                    </div>
    ...
    $(document).ready(function () {
		...
		function loadItems() {
			...
			if (localStorage.getItem('po_items')) {
				...
				tr_html += '<td><input name="given_quantity[]" id="given_quantity_' + row_no + '" data-item="' + row_no + '" class="form-control given_quantity" readonly value="'+ (this.given_quantity != 0 ? this.given_quantity :  '') +'"></td>';
				...
				tr_html += '<td><input name="balance_quantity[]" id="balance_quantity_' + row_no + '" data-item="' + row_no + '" class="form-control balance_quantity" value="'+  (this.balance_quantity != 0 ? this.balance_quantity :  '')+'"></td>';
