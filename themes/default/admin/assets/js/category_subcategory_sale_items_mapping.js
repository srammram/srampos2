    ...
    $(document).on('ifChanged','.check_all',function(e){        
        $('.recipe-item').iCheck('check');
        $('.recipe-group').iCheck('check');
        $('.recipe-subgroup').iCheck('check');
    });
    $(document).on('ifUnchecked','.check_all',function(e){        
        $('.recipe-item').iCheck('uncheck');
        $('.recipe-group').iCheck('uncheck');
        $('.recipe-subgroup').iCheck('uncheck');
    });
